/*! For license information please see bundle3_others.js.LICENSE.txt */
!(function () {
  var t = {
      9367: function (t, e) {
        var n, i;
        (n = function (t, e) {
          ...
          function s(t) {
            if (t && t.nodeName && "TEXTAREA" === t.nodeName && !o.has(t)) {
              ...
              t.addEventListener("autosize:destroy", a, !1),
                ...
                o.set(t, { destroy: a, update: u }),
                "vertical" === (l = window.getComputedStyle(t, null)).resize
                  ? (t.style.resize = "none")
                  : "both" === l.resize && (t.style.resize = "horizontal"),
                (e =
          ...
          void 0 === (i = n.apply(e, [t, e])) || (t.exports = i);
      },
      2897: function (t, e, n) {
        n(4783)(function () {});
      },
      1469: function (t, e, n) {
        const i = n(4783),
          o = n(9828);
        i(function () {
          o(".add-info__text.ellipsis");
        });
      },
      9580: function (t, e, n) {
        n(4783)(function () {
          var t = document.querySelector(".article-index__letter-active");
          if (t) {
            document
              .querySelector(".article-index__alphabet")
              .addEventListener("click", function (e) {
                if (
                  (e.preventDefault(),
                  e.target.classList.contains("article-index__letter"))
                ) {
                  var n = this.querySelector(".active");
            ...
            var e = document.querySelector(".article-index__tabs");
            if (e) {
              const v = ".article-index__tab-pane";
              var n,
                i = document.documentElement.clientWidth,
                o = 1,
                r = document.querySelector(".article-index__nav-btn--prev"),
                s = document.querySelector(".article-index__nav-btn--next"),
                a = document.getElementById("article-index-tab-content"),
                l = 1,
                [c, l, d, u] = [];
              (r.disabled = !1),
                  ...
                  o < l
                    ...
                    : (function () {
                        for (var t = 0; t < n.length; t++)
                          if (n[t].classList.contains("active")) {
                            (t == n.length - 1 ? n[0] : n[t + 1]).dispatchEvent(
                              new Event("click", { bubbles: !0 })
                            );
                            break;
                          }
                ...
                m();
              var p = e.querySelectorAll('button[data-bs-toggle="tab"]');
              for (var f of p)
              ...
              function h(t) {
                o = 1;
                for (
                  var e = 1, n = t.querySelectorAll(v), r = 0;
                  r < n.length;
                  r++
                )
                ...
                var s = getComputedStyle(a),
                  l =
                    ...
                    t.querySelector(v + ".active"));
                if (!l || 0 == l.length) return [l, e];
                var c = l.querySelector("li:last-child");
                if (!c || 0 == c.length) return [l, e];
                var d = c.offsetLeft,
                  u = c.clientWidth,
                  p = d + u,
                  f = l.clientWidth,
              ...
              function g(t) {
                ...
                for (
                  var n = e
                      .querySelector(".article-index__tab-pane.active")
                      .querySelectorAll("a"),
                    i = 0;
                  i < n.length;
                  i++
                  ...
                  (n[i].style.display = "block"),
                    n[i].textContent[0].toUpperCase() != t &&
              ...
              function m() {
                ...
                for (
                  var i = e.querySelectorAll(v + " a"), o = 0;
                  o < i.length;
                  o++
                )
                  i[o].style.display = "block";
                var r = document.querySelectorAll(".article-index__alphabet a");
                for (o = 0; o < r.length; o++)
                  r[o].classList.remove("active"),
                    r[o].removeAttribute("disabled");
                var s = document.querySelectorAll(
                    ".article-index__tab-pane.active li"
                  ),
                  a = Array.from(s);
                for (var l of (console.log(a), r))
                  void 0 ===
                    a.find(
                      (t) =>
                        t.textContent.replace(/\s+/g, "")[0].toUpperCase() ==
                        l.innerHTML
                    ) && l.setAttribute("disabled", "");
                n = document.querySelectorAll(
                  ".article-index__alphabet a:not([disabled])"
                );
                var c = document.querySelector(
                  ".article-index__alphabet li a:not([disabled])"
                );
                c &&
                  (c.classList.add("active"),
                  (t.textContent = c.innerText),
                  g(c.innerText));
              }
            }
          }
      ...
      5086: function (t, e, n) {
          ...
          c = (function () {
            ...
            return (
              ...
              (t.prototype.trigger = function (t, e) {
                if (!this.firstElement) return this;
                var n = new CustomEvent(t.split(".")[0], { detail: e || null });
        ...
        var f = function (t, e, n, i) {
            void 0 === n && (n = 0);
            var o = d(t).attr("data-lg-size") || i;
            if (o) {
              var r = o.split(",");
              if (r[1])
                for (var s = window.innerWidth, a = 0; a < r.length; a++) {
                  var l = r[a];
            ...
            return (
              (t.prototype.generateSettings = function (t) {
                if (
                  ...
                  var e = i(
                    i({}, this.settings.mobileSettings),
                  ...
                  var o = this.settings.ariaLabelledby
                    ...
                    c =
                      ...
                      (".lg-sub-html" === this.settings.appendSubHtmlTo
                        ...
                        : "") +
                      "\n                </div>\n            </div>\n        </div>\n        ";
                  d(this.settings.container).append(c),
                    document.body !== this.settings.container &&
              ...
              (t.prototype.getItems = function () {
                ...
                return (
                  (e = this.items),
                  (n = this.settings.extraProps),
                  (i = this.settings.getCaptionFromTitleOrAlt),
                  ...
                  [].forEach.call(e, function (t) {
                    for (var e = {}, n = 0; n < t.attributes.length; n++) {
                      ...
                      if (a.specified) {
                        var l = p(a.name),
                          c = "";
                        s.indexOf(l) > -1 && (c = l), c && (e[c] = a.value);
                      }
                    }
                    var u = d(t),
                      f = u.find("img").first().attr("alt"),
                      h = u.attr("title"),
                      g = o ? u.attr(o) : u.find("img").first().attr("src");
                    (e.thumb = g),
                      i && !e.subHtml && (e.subHtml = h || f || ""),
                      (e.alt = f || h || ""),
                      r.push(e);
                  }),
                  r
              ...
              (t.prototype.openGallery = function (t, e) {
                ...
                if (
                  ...
                  this.zoomFromOrigin &&
                    ...
                    (r = h(e, this.outer, a, l, this.currentImageSize))),
                  ...
                  setTimeout(function () {
                    ...
                    setTimeout(function () {
                      ...
                      setTimeout(function () {
                        ...
                        setTimeout(function () {
                          n.settings.trapFocus &&
                            document.body === n.settings.container &&
                            n.trapFocus();
                        }, n.settings.backdropDuration + 50),
                        (n.zoomFromOrigin && r) ||
                          setTimeout(function () {
                            n.outer.addClass("lg-visible");
                          }, n.settings.backdropDuration),
                        n.slide(t, !1, !1, !1),
                        n.LGel.trigger("lgAfterOpen");
                    }),
                    document.body === this.settings.container &&
              ...
              (t.prototype.getMediaContainerPosition = function () {
                ...
                return { top: t, bottom: (i ? i.clientHeight : 0) + n };
              }),
              ...
              (t.prototype.getDummyImageContent = function (t, e, n) {
                var i;
                if ((this.settings.dynamic || (i = d(this.items).eq(e)), i)) {
                  var o;
                  if (
                    !(o = this.settings.exThumbImage
                ...
                var i = this.galleryItems[n],
                  ...
                  c =
                    ...
                    (this.isFirstSlideWithZoomAnimation()
                      ? this.getDummyImageContent(e, n, l)
                      : g(n, t, l, r, s, a)) +
                    "</picture>";
                e.prepend(c);
              }),
              (t.prototype.onSlideObjectLoad = function (t, e, n, i) {
                var o,
                  r = t.find(".lg-object").first();
                ((o = r.get()) && o.complete && 0 !== o.naturalWidth) || e
                  ? n()
              ...
              (t.prototype.onLgObjectLoad = function (t, e, n, i, o, r) {
                var s = this;
                this.onSlideObjectLoad(
                  t,
                  r,
                  function () {
                    s.triggerSlideItemLoad(t, e, n, i, o);
                  },
                  function () {
              ...
              (t.prototype.triggerSlideItemLoad = function (t, e, n, i, o) {
                var r = this,
                  s = this.galleryItems[e],
                  a =
                    o && "video" === this.getSlideType(s) && !s.poster ? i : 0;
                setTimeout(function () {
                  t.addClass("lg-complete lg-complete_"),
              ...
              (t.prototype.addSlideVideoInfo = function (t) {
                ...
                t.forEach(function (t, n) {
                  (t.__slideVideoInfo = (function (t, e, n) {
                    if (!t)
                      return e
                        ? { html5: !0 }
                        : void console.error(
              ...
              (t.prototype.loadContent = function (t, e) {
                var n = this,
                  ...
                  c = i.src,
                  u = i.video,
                  p = u && "string" == typeof u ? JSON.parse(u) : u;
                if (i.responsive) {
                ...
                if (
                  ...
                  if (y) {
                    ...
                    b &&
                      this.zoomFromOrigin &&
                      this.currentImageSize &&
                      (T = this.getDummyImageContent(o, t, "")),
                      ...
                      })(r, T || "", v, this.settings.strings.playVideo, m)),
                      o.prepend(O);
                  } else if (m)
                    (O =
                      '<div class="lg-video-cont " style="' + v + '"></div>'),
                      o.prepend(O);
                  else if ((this.setImgMarkup(c, o, t), s || l)) {
                    var L = o.find(".lg-object");
                  ...
                  (r || m) &&
                    ...
                    this.LGel.trigger("lgAfterAppendSlide", { index: t }),
                    this.lGalleryOn &&
                      ".lg-item" === this.settings.appendSubHtmlTo &&
                      this.addHtml(t);
                }
                var I = 0;
                w && !d(document.body).hasClass("lg-from-hash") && (I = w),
                  this.isFirstSlideWithZoomAnimation() &&
                    (setTimeout(function () {
                      o.removeClass(
                    ...
                    o.hasClass("lg-loaded") ||
                      setTimeout(function () {
                        ...
                        ("image" === n.getSlideType(i) ||
                          ...
                          (n.onLgObjectLoad(o, t, w, I, !0, !1),
                          n.onSlideObjectLoad(
                            o,
                            !(!m || !m.html5 || r),
                            function () {
                              n.loadContentOnFirstSlideLoad(t, o, I);
                            },
                            function () {
                              n.loadContentOnFirstSlideLoad(t, o, I);
                            }
                  ...
                  (this.isFirstSlideWithZoomAnimation() &&
                    ...
                    this.onLgObjectLoad(o, t, w, I, b, !(!m || !m.html5 || r)),
                  (this.zoomFromOrigin && this.currentImageSize) ||
                ...
                if (this.galleryItems.length <= 3)
                  return (
                    this.galleryItems.forEach(function (t, e) {
                      o.push("lg-item-" + i.lgId + "-" + e);
                    }),
                    o
                  );
                if (t < (this.galleryItems.length - 1) / 2) {
                  for (var a = t; a > t - r / 2 && a >= 0; a--)
                  ...
                  for (
                    a = t;
                    a <= this.galleryItems.length - 1 && a < t + r / 2;
                    a++
                  )
                    o.push("lg-item-" + this.lgId + "-" + a);
                ...
                "lg-slide" !== this.settings.mode &&
                  ...
                  setTimeout(function () {
                    ...
                    if ("horizontal" === o.swipeDirection) {
                      ...
                      i < 0 && a > o.settings.swipeThreshold
                        ? (o.goToNextSlide(!0), (s = !1))
                        : i > 0 &&
                          a > o.settings.swipeThreshold &&
                          (o.goToPrevSlide(!0), (s = !1));
                    ...
                    if (
                      ...
                      s && Math.abs(t.pageX - e.pageX) < 5)
                    ) {
                      var l = d(n.target);
                      o.isPosterElement(l) && o.LGel.trigger(r);
                    }
                ...
                this.settings.enableSwipe &&
                  ...
                  this.$inner.on("touchend.lg", function (s) {
                    if ("swipe" === t.touchAction) {
                      if (i) (i = !1), t.touchEnd(n, e, s);
                      else if (o) {
                        var a = d(s.target);
                        t.isPosterElement(a) && t.LGel.trigger(r);
                      }
              ...
              (t.prototype.enableDrag = function () {
                ...
                this.settings.enableDrag &&
                  ...
                  d(window).on("mousemove.lg.global" + this.lgId, function (r) {
                    i &&
                      t.lgOpened &&
                      ((o = !0),
                  ...
                  d(window).on("mouseup.lg.global" + this.lgId, function (s) {
                    if (t.lgOpened) {
                      var a = d(s.target);
                      o
                        ? ((o = !1),
                          t.touchEnd(n, e, s),
                          t.LGel.trigger("lgDragEnd"))
                        : t.isPosterElement(a) && t.LGel.trigger(r),
                        i &&
                          ((i = !1),
                          t.outer
              ...
              (t.prototype.setTranslate = function (t, e, n, i, o) {
                void 0 === i && (i = 1),
                  void 0 === o && (o = 1),
                  t.css(
                    "transform",
                ...
                return (
                  ...
                  setTimeout(function () {
                    e.zoomFromOrigin &&
                      ...
                      e.$inner.empty(),
                      e.lgOpened &&
                        e.LGel.trigger("lgAfterClose", { instance: e }),
        ...
        n(4783)(function () {
          var t = document.querySelector(".article__float");
            t &&
              t.clientHeight <= 720 &&
              document.documentElement.clientWidth >= 1024 &&
              (
              new StickySidebar(".article__float", {
                containerSelector: ".article__aside",
                innerWrapperSelector: ".article__float-container",
                resizeSensor: !0,
                topSpacing: 100,
              }));
          let e = document.querySelectorAll(".article__lg-item");
          console.log("lightGalleryImages 1", e),
            e.forEach(function (t) {
              console.log("1", t),
                (function (t, e) {
                  new v(t, e);
                })(t, { selector: ".article__lg-img" });
            });
        });
      },
      5154: function (t, e, n) {
        const i = n(4783),
          { mobileSearchOpen: o } = n(802),
          { mobileSearchClose: r } = n(802);
        i(function () {
          for (
          ...
          function n() {
            ...
            if (t && e) {
              ...
              if (n < 1024) {
                var i = document.getElementsByClassName("search-form")[0];
                i &&
                  (void 0 === i.navMobileOpen && (i.navMobileOpen = !1),
                  (i.navMobileOpen = !i.navMobileOpen),
                  i.navMobileOpen ? o(i) : r(i));
              }
              "off-canvas" === t &&
                n >= 1024 &&
        ...
        i(function () {
          function t() {
            ...
            if (!(document.documentElement.clientWidth >= 768))
              for (
                t = document.getElementsByClassName("compare-slider__before"),
                  e = 0;
                e < t.length;
                e++
              )
            ...
            function n(t) {
              var e,
                n = 0;
              (t.style.width = ""), (e = t.offsetWidth), t.offsetHeight;
              var i = o(t, ".compare-slider__before")[0],
                r = o(t, ".compare-slider__after")[0],
                s = i.querySelector(".compare-slider__content--before"),
                a = r.querySelector(".compare-slider__content--after");
              ...
              function h(i) {
                ...
                (o = (function (e) {
                  ...
                  return (
                    ...
                    e.pageX - n.left - window.pageXOffset
                  );
                })(i)),
                  o < 0 && (o = 0),
                  o > e && (o = e),
                  (function (e) {
                    (t.style.width = e + "px"),
                      (l.style.left = t.offsetWidth - l.offsetWidth / 2 + "px");
                  })(o);
              }
              (a.style.width = a.offsetWidth + "px"),
                ...
                (l = r.querySelector(".compare-slider__slider")) ||
                  ...
                  sliderHandle.setAttribute(
                    "class",
                    "compare-slider__slider-handle"
                  ),
                  l.appendChild(sliderHandle),
                  r.insertBefore(l, i)),
                ...
                (l.style.left = e / 2 - l.offsetWidth / 2 + "px");
            }
          }
          t(), window.addEventListener("resize", r(t, 100));
        });
      },
      7590: function (t, e, n) {
        const i = n(4783),
          o = (n(6178), n(9828));
        i(function () {
          var t = document.getElementsByClassName("cure ")[0];
          if (t) {
            var e = t.getElementsByClassName("btn--show-more")[0];
            e &&
              e.addEventListener("click", function (e) {
                console.log("btnShow click"),
                  ...
                  (function (e, n) {
                    ...
                    var i = t.getElementsByClassName(
                      "article-preview__list"
                    )[0];
                    i.classList.contains("article-preview__list--show-all")
                      ? i.classList.remove("article-preview__list--show-all")
                      : (i.classList.add("article-preview__list--show-all"),
                        o(
                          ".article-preview:nth-child(n+3) .article-preview__ellipsis--cure"
                        ),
                        n.classList.contains("lg_!hidden") ||
                          n.classList.add("lg_!hidden"));
                  })(0, this);
              });
          }
        });
      ...
      7760: function (t, e, n) {
        n(4783)(function () {
          var t = document.querySelectorAll(".field-num");
          t.length &&
            Array.prototype.forEach.call(t, function (t) {
              const e = t.querySelector(".field-num__input"),
                n = e.getAttribute("min") ? +e.getAttribute("min") : -1 / 0,
                i = e.getAttribute("max") ? +e.getAttribute("max") : 1 / 0,
                o = e.getAttribute("step") ? +e.getAttribute("step") : 1;
              t.addEventListener("click", function (t) {
                if (
                  t.target.classList.contains("field-num__btn") &&
                  !e.getAttribute("disabled")
                ) {
                  let r = parseInt(e.value);
                  isNaN(r) && (r = 0),
                    t.target.classList.contains("field-num__btn--plus") &&
                      r < i &&
                      (e.value = r + o),
                    t.target.classList.contains("field-num__btn--minus") &&
                      r > n &&
                      (e.value = r - o);
                }
              });
      ...
      243: function (t, e, n) {
        const i = n(9367);
        n(4783)(function () {
          i(document.querySelectorAll("textarea"));
        });
      },
      3630: function (t, e, n) {
        "use strict";
        ...
        function h(t) {
          return d(f(t)).left + u(t).scrollLeft;
        }
        function g(t) {
              ...
              (("body" !== p(e) || m(g)) &&
                (y =
                  (o = e) !== i(o) && r(o)
                    ...
                    : u(o)),
              r(e)
                ? (((b = d(e, !0)).x += e.clientLeft), (b.y += e.clientTop))
                : g && (b.x = h(g))),
            {
        ...
        function x(t, e) {
          ...
          var o = w(t),
            ...
            s = i(o),
            a = r ? [s].concat(s.visualViewport || [], m(o) ? o : []) : o,
            l = e.concat(a);
          return r ? l : l.concat(x(b(a)));
        }
        function S(t) {
          return ["table", "td", "th"].indexOf(p(t)) >= 0;
        }
        function E(t) {
          return r(t) && "fixed" !== g(t).position ? t.offsetParent : null;
        }
        function C(t) {
          for (
            var e = i(t), n = E(t);
            n && S(n) && "static" === g(n).position;

          )
            n = E(n);
          return n &&
            ("html" === p(n) || ("body" === p(n) && "static" === g(n).position))
            ? e
            : n ||
                (function (t) {
                  var e =
        ...
        var O = "top",
          ...
          z = "viewport",
          P = "popper",
          D = _.reduce(function (t, e) {
            return t.concat([e + "-" + A, e + "-" + M]);
          }, []),
          j = [].concat(_, [k]).reduce(function (t, e) {
            return t.concat([e, e + "-" + A, e + "-" + M]);
          }, []),
          B = [
            "beforeRead",
            "read",
              ...
              u = {
                ...
                forceUpdate: function () {
                  if (!d) {
                    ...
                    if (W(e, n)) {
                      (l.rects = {
                        reference: v(e, C(n), "fixed" === l.options.strategy),
                        popper: y(n),
                      }),
                        (l.reset = !1),
        ...
        function U(t) {
          ...
          if (u) {
            var A = C(n),
              ...
              P = "clientWidth";
            A === i(n) &&
              "static" !== g((A = f(n))).position &&
              "absolute" === l &&
              ((z = "scrollHeight"), (P = "scrollWidth")),
              (r === O || ((r === I || r === L) && s === M)) &&
                ((k = T),
                (b -=
                  (h && A === _ && _.visualViewport
          ...
          var D,
            j = Object.assign({ position: l }, u && G),
            B =
              !0 === p
                ? (function (t) {
                    var e = t.x,
                    ...
                    return { x: c(e * i) / i || 0, y: c(n * i) / i || 0 };
                  })({ x: v, y: b })
                : { x: v, y: b };
          return (
            (v = B.x),
          ...
          return e === z
            ...
            : et(
                (function (t) {
                  ...
                  return (
                    "rtl" === g(o || n).direction &&
                      (l += a(n.clientWidth, o ? o.clientWidth : 0) - r),
        ...
        function rt(t, e) {
          ...
          var n = e,
              ...
              var i =
                  "clippingParents" === e
                    ? (function (t) {
                        var e = x(b(t)),
                          n =
                            ["absolute", "fixed"].indexOf(g(t).position) >= 0 &&
                            r(t)
                              ? C(t)
                              : t;
                        return o(n)
                          ? e.filter(function (t) {
                              return o(t) && tt(t, n) && "body" !== p(t);
                            })
                          : [];
                      })(t)
                    : [].concat(e),
                ...
                d = s.reduce(function (e, n) {
                  ...
                  return (
                    (e.top = a(i.top, e.top)),
                    (e.right = l(i.right, e.right)),
                    (e.bottom = l(i.bottom, e.bottom)),
            ...
            })(o(D) ? D : D.contextElement || f(t.elements.popper), u, m),
            B = d(t.elements.reference),
            F = Y({
              reference: B,
              element: M,
              strategy: "absolute",
            ...
            q = et(Object.assign({}, M, F)),
            W = y === P ? q : B,
            N = {
              top: j.top - W.top + k.top,
              bottom: W.bottom - j.bottom + k.bottom,
              left: j.left - W.left + k.left,
              right: W.right - j.right + k.right,
            },
            H = t.modifiersData.offset;
          if (y === P && H) {
            var V = H[s];
            Object.keys(N).forEach(function (t) {
              var e = [L, T].indexOf(t) >= 0 ? 1 : -1,
                n = [O, T].indexOf(t) >= 0 ? "y" : "x";
              N[t] += V[n] * e;
            });
          }
          return N;
        ...
        function lt(t) {
          return [O, L, T, I].some(function (e) {
            return t[e] >= 0;
          });
        }
        var ct = N({
                  ...
                  if (_) {
                    if (r) {
                      var F,
                        ...
                        nt = st(0, M[N], Z[N]),
                        it = S
                          ? M[N] / 2 - U - nt - tt - D.mainAxis
                          : X - nt - tt - D.mainAxis,
                        ot = S
                          ? -M[N] / 2 + U + nt + et + D.mainAxis
                          : K + nt + et + D.mainAxis,
                        at = e.elements.arrow && C(e.elements.arrow),
                        lt = at
                          ? "y" === E
                            ? at.clientTop || 0
                            : at.clientLeft || 0
                          : 0,
                        ct = null != (F = null == j ? void 0 : j[E]) ? F : 0,
                        dt = H + ot - ct,
                        ut = st(
                          g ? l(Y, H + it - ct - lt) : Y,
                          H,
                    ...
                    if (c) {
                      var pt,
                        ...
                        yt = gt - b[ht],
                        bt = -1 !== [O, I].indexOf(w),
                        wt = null != (pt = null == j ? void 0 : j[k]) ? pt : 0,
                        xt = bt ? vt : gt - M[mt] - z[mt] - wt + D.altAxis,
                        St = bt ? gt + M[mt] + z[mt] - wt - D.altAxis : yt,
                        Et =
                          g && bt
                            ? (function (t, e, n) {
                                var i = st(t, e, n);
              ...
              },
              {
                ...
                fn: function (t) {
                  var e,
                    ...
                    a = V(n.placement),
                    l = $(a),
                    c = [I, L].indexOf(a) >= 0 ? "height" : "width";
                  if (r && s) {
                    var d = (function (t, e) {
                        return it(
                          "number" !=
              ...
              },
              {
                ...
                fn: function (t) {
                  var e = t.state,
                    ...
                    s = rt(e, { elementContext: "reference" }),
                    a = rt(e, { altBoundary: !0 }),
                    l = at(s, i),
                    c = at(a, o, r),
                    d = lt(l),
                    u = lt(c);
        ...
        function At() {
          kt.isTouch ||
            ((kt.isTouch = !0),
            window.performance && document.addEventListener("mousemove", Mt));
        }
        function Mt() {
          var t = performance.now();
          t - _t < 20 &&
            ((kt.isTouch = !1), document.removeEventListener("mousemove", Mt)),
            (_t = t);
        }
        function zt() {
          var t,
        ...
        function Bt(t) {
          var e = (t.plugins || []).reduce(function (e, n) {
            ...
            return (
              o &&
                (e[o] = void 0 !== t[o] ? t[o] : null != (i = Dt[o]) ? i : r),
              e
            );
          }, {});
        ...
        function Ft(t, e) {
          var n = Object.assign(
            {},
            e,
            { content: vt(e.content, [t]) },
            e.ignoreAttributes
              ? {}
              : (function (t, e) {
                  return (
                    e
                      ? Object.keys(Bt(Object.assign({}, Dt, { plugins: e })))
                      : jt
                  ).reduce(function (e, n) {
        ...
        function Wt(t) {
          ...
          return (
            !0 === t
              ? (e.className = ut)
              : ((e.className = pt), Ct(t) ? e.appendChild(t) : qt(e, t)),
            e
          );
        }
        function Nt(t, e) {
        ...
        function Ht(t) {
          ...
          return {
            ...
            arrow: n.find(function (t) {
              return t.classList.contains(ut) || t.classList.contains(pt);
            }),
          ...
          function o(n, i) {
            ...
            i.theme
              ...
              i.arrow
                ? a
                  ? n.arrow !== i.arrow &&
                    (r.removeChild(a), r.appendChild(Wt(i.arrow)))
                  : r.appendChild(Wt(i.arrow))
                : a && r.removeChild(a);
          }
          return (
            (i.className = dt),
        ...
        function Gt(t, e) {
          var n,
            ...
            l,
            c,
            d = Ft(t, Object.assign({}, Dt, Bt(St(e)))),
            u = !1,
            p = !1,
            f = !1,
            h = !1,
            g = [],
            m = yt(G, d.interactiveDebounce),
            v = Rt++,
            y = (c = d.plugins).filter(function (t, e) {
            ...
            b = {
              ...
              setProps: function (e) {
                if (!b.state.isDestroyed) {
                  z("onBeforeUpdate", [b, e]), $();
                  var n = b.props,
                    i = Ft(
                      t,
                      Object.assign({}, n, St(e), { ignoreAttributes: !0 })
                    );
                  (b.props = i),
                    R(),
                    n.interactiveDebounce !== i.interactiveDebounce &&
                      (j(), (m = yt(G, i.interactiveDebounce))),
              ...
              show: function () {
                var t = b.state.isVisible,
                  ...
                  o = gt(b.props.duration, 0, Dt.duration);
                if (
                  !(
                    t ||
                    e ||
                    ...
                    (z("onShow", [b], !1), !1 === b.props.onShow(b))
                  )
                ) {
                  if (
                    ((b.state.isVisible = !0),
                    L() && (x.style.visibility = "visible"),
                    M(),
                    W(),
                  ...
                  (a = function () {
                    ...
                    (c = I()),
                    (s =
                      (b.props.interactive && l === ht) || "parent" === l
                        ? c.parentNode
                        : vt(l, [c])).contains(x) || s.appendChild(x),
                    (b.state.isMounted = !0),
                    J();
                }
              },
              hide: function () {
                var t = !b.state.isVisible,
                  e = b.state.isDestroyed,
                  n = !b.state.isEnabled,
                  i = gt(b.props.duration, 1, Dt.duration);
                if (
                  !(t || e || n) &&
                  (z("onHide", [b], !1), !1 !== b.props.onHide(b))
                ) {
                  if (
                    ((b.state.isVisible = !1),
                    (b.state.isShown = !1),
                    ...
                    var o = _(),
                      r = o.box,
                      s = o.content;
                    b.props.animation && (Ot([r, s], i), Tt([r, s], "hidden"));
                  }
                  P(),
                    D(),
                    b.props.animation
              ...
              hideWithInteractivity: function (t) {
                k().addEventListener("mousemove", m), wt($t, m), m(t);
              },
              enable: function () {
                b.state.isEnabled = !0;
              },
          ...
          function A(t) {
            return (b.state.isMounted && !b.state.isVisible) ||
              ...
              (r && "focus" === r.type)
              ? 0
              : gt(b.props.delay, t ? 0 : 1, Dt.delay);
          }
          function M(t) {
            void 0 === t && (t = !1),
          ...
          function P() {
            ...
            if (e.content) {
              ...
              bt(b.props.triggerTarget || t).forEach(function (t) {
                ...
                if (b.state.isVisible) t.setAttribute(n, e ? e + " " + i : i);
                else {
            ...
            !C &&
              ...
              bt(b.props.triggerTarget || t).forEach(function (t) {
                b.props.interactive
                  ? t.setAttribute(
                      "aria-expanded",
                      b.state.isVisible && t === I() ? "true" : "false"
                    )
                  : t.removeAttribute("aria-expanded");
              });
          }
          ...
          function B(e) {
            if (!kt.isTouch || (!f && "mousedown" !== e.type)) {
              var n = (e.composedPath && e.composedPath()[0]) || e.target;
              if (!b.props.interactive || !It(x, n)) {
                if (
          ...
          function W() {
            ...
            t.addEventListener("mousedown", B, !0),
              t.addEventListener("touchend", B, ft),
              t.addEventListener("touchstart", q, ft),
              t.addEventListener("touchmove", F, ft);
          }
          function N() {
            var t = k();
            t.removeEventListener("mousedown", B, !0),
              t.removeEventListener("touchend", B, ft),
              t.removeEventListener("touchstart", q, ft),
              t.removeEventListener("touchmove", F, ft);
          }
          function H(t, e) {
            var n = _().box;
            function i(t) {
            ...
            if (0 === t) return e();
            Lt(n, "remove", s), Lt(n, "add", i), (s = i);
          }
          function V(e, n, i) {
            void 0 === i && (i = !1),
              bt(b.props.triggerTarget || t).forEach(function (t) {
                t.addEventListener(e, n, i),
                  g.push({ node: t, eventType: e, handler: n, options: i });
              });
          }
          function R() {
            var t;
            T() &&
              (V("touchstart", Y, { passive: !0 }),
              V("touchend", U, { passive: !0 })),
          ...
          function Y(t) {
            var e,
              n = !1;
            if (b.state.isEnabled && !K(t) && !p) {
              var i = "focus" === (null == (e = r) ? void 0 : e.type);
              (r = t),
                (l = t.currentTarget),
                D(),
                !b.state.isVisible &&
          ...
          function X(t) {
            (b.props.trigger.indexOf("focusin") < 0 && t.target !== I()) ||
              (b.props.interactive &&
                t.relatedTarget &&
          ...
          function K(t) {
            return !!kt.isTouch && T() !== t.type.indexOf("touch") >= 0;
          }
          function J() {
            Z();
            var e = b.props,
              ...
              c = r
                ? {
                    ...
                    contextElement: r.contextElement || I(),
                  }
                : t,
              d = [
          ...
          function tt(t) {
            b.clearDelayTimeouts(), t && z("onTrigger", [b, t]), W();
            var e = A(!0),
              i = O(),
              o = i[0],
              r = i[1];
            kt.isTouch && "hold" === o && r && (e = r),
              e
                ? (n = setTimeout(function () {
                    b.show();
                  }, e))
        ...
        function Ut(t, e) {
          void 0 === e && (e = {});
          var n = Dt.plugins.concat(e.plugins || []);
          document.addEventListener("touchstart", At, ft),
            window.addEventListener("blur", zt);
          var i,
            o = Object.assign({}, e, { plugins: n }),
            r = ((i = t),
            Ct(i)
              ? [i]
              : (function (t) {
              ...
              : Array.isArray(i)
              ? i
              : xt(document.querySelectorAll(i))).reduce(function (t, e) {
              var n = e && Gt(e, o);
              return n && t.push(n), t;
            }, []);
          return Ct(t) ? r[0] : r;
        ...
        n(4783)(function () {
          ...
          for (var e of t) {
            var n = e.dataset.content,
              i = "top";
            e.classList.contains("info-tip--right") && (i = "right");
            var o,
              r = e.dataset && e.dataset.theme ? e.dataset.theme : "info-tip";
            "link-tip" == r && (o = [70, 0]),
              n &&
                Xt(e, {
                  content: n,
      ...
      1818: function (t, e, n) {
        n(4783)(function () {
          var t = document.querySelectorAll(".load-file__input");
          for (input of t)
            input.addEventListener("change", function () {
              var t,
                e = this.value.substr(this.value.lastIndexOf("\\") + 1);
              console.log(e),
                console.log(this.files[0].size),
                console.log((10 * this.files[0].size) / 1024),
                console.log(Math.floor((10 * this.files[0].size) / 1024) / 10);
              for (var n = this.nextElementSibling; n; ) {
                if (n.classList.contains("load-file__info")) {
                  t = n;
                  break;
                }
              ...
              t &&
                (t.innerHTML =
                  this.files[0].name +
                  ", " +
                  Math.floor((10 * this.files[0].size) / 1024) / 10 +
                  " Мб");
            });
        });
      },
      651: function (t, e, n) {
        ...
        function i(t, e) {
          ...
          else t && i(Object.keys(t), (n) => e(t[n], n, t));
          return t;
        }
        function o(t, e) {
          const n = h(e);
          if (v(e) || n) {
            ...
            if (t) {
              ...
              i = n
                ? Ot(t, o, e)
                : e.reduce((e, n) => ((e[n] = Ot(t, o, n)), e), i);
            }
            return i;
          }
          t && i(k(e), (n) => Tt(t, n, e[n]));
        }
        n.r(e);
        const r = (t, e) => {
            const { o: n, u: i, _: o } = t;
            ...
            const a = (t, e) => {
              const n = s,
                a = t,
                l = e || (i ? !i(n, a) : n !== a);
              return (l || o) && ((s = a), (r = n)), [s, l, r];
            };
            return [e ? (t) => a(e(s, r), t) : a, (t) => [s, !!t, r]];
          },
          s = () => "undefined" != typeof window,
          a = s() && Node.ELEMENT_NODE,
          { toString: l, hasOwnProperty: c } = Object.prototype,
          d = (t) => void 0 === t,
          u = (t) => null === t,
          p = (t) =>
            d(t) || u(t)
          ...
          f = (t) => "number" == typeof t,
          h = (t) => "string" == typeof t,
          g = (t) => "boolean" == typeof t,
          m = (t) => "function" == typeof t,
          v = (t) => Array.isArray(t),
          y = (t) => "object" == typeof t && !v(t) && !u(t),
          b = (t) => {
            const e = !!t && t.length,
              n = f(e) && e > -1 && e % 1 == 0;
            return !(
          ...
          w = (t) => {
            ...
            const n = "constructor",
              ...
              o = i && i.prototype,
              r = c.call(t, n),
              s = o && c.call(o, "isPrototypeOf");
            if (i && !r && !s) return !1;
            for (e in t);
            return d(e) || c.call(t, e);
          },
          x = (t) => {
            const e = HTMLElement;
            return !!t && (e ? t instanceof e : t.nodeType === a);
          },
          S = (t) => {
            const e = Element;
            return !!t && (e ? t instanceof e : t.nodeType === a);
          ...
          C = (t, e, n) => (
            n || h(e) || !b(e) ? t.push(e) : Array.prototype.push.apply(t, e), t
          ),
          O = (t) => {
            const e = Array.from,
              n = [];
          ...
          T = (t) => !!t && 0 === t.length,
          L = (t, e, n) => {
            i(t, (t) => t && t.apply(void 0, e || [])), !n && (t.length = 0);
          },
          ...
          M = (t, e, n, i) => {
            if (d(i)) return n ? n[t] : e;
            n && (h(i) || f(i)) && (n[t] = i);
          },
          z = (t, e, n) => {
            if (d(n)) return t ? t.getAttribute(e) : null;
          ...
          P = (t, e, n, i) => {
            if (n) {
              const o = z(t, e) || "",
                r = new Set(o.split(" "));
              r[i ? "add" : "delete"](n), z(t, e, O(r).join(" ").trim());
            }
          },
          D = (t, e) => {
            t && t.removeAttribute(e);
          },
          j = (t, e) => M("scrollLeft", 0, t, e),
          B = (t, e) => M("scrollTop", 0, t, e),
          F = s() && Element.prototype,
          q = (t, e) => {
            const n = [],
              i = e ? (S(e) ? e : null) : document;
            return i ? C(n, i.querySelectorAll(t)) : n;
          },
          W = (t, e) => !!S(t) && (F.matches || F.msMatchesSelector).call(t, e),
          N = (t) => (t ? O(t.childNodes) : []),
            ...
            if (n && t) {
              ...
              b(n)
                ? ((o = document.createDocumentFragment()),
                  i(n, (t) => {
                    t === r && (r = t.previousSibling), o.appendChild(t);
                  }))
                : (o = n),
                e && (r ? r !== e && (r = r.nextSibling) : (r = t.firstChild)),
          ...
          U = (t) => {
            ...
            return t && z(e, "class", t), e;
          },
          X = (t) => {
            const e = U();
            return (e.innerHTML = t.trim()), i(N(e), (t) => G(t));
          },
          ...
          nt = (t) => {
            if (s()) {
              ...
              return (
                I(Q, t) ||
                  (i(Z, (n) => ((e = e || window[n + K(t)]), !e)), (Q[t] = e)),
                e
              );
            }
          },
          it = nt("MutationObserver"),
          ot = nt("IntersectionObserver"),
          rt = nt("ResizeObserver"),
          st = nt("cancelAnimationFrame"),
          at = nt("requestAnimationFrame"),
          lt = s() && window.setTimeout,
          ct = s() && window.clearTimeout,
          dt = (t, e, n, o) => {
            if (t && e) {
              let r = !0;
              return (
                i(n, (n) => {
                  (o ? o(t[n]) : t[n]) !== (o ? o(e[n]) : e[n]) && (r = !1);
                }),
                r
              );
            }
          ...
          ut = (t, e) => dt(t, e, ["w", "h"]),
          pt = (t, e) => dt(t, e, ["x", "y"]),
          ft = (t, e) => dt(t, e, ["t", "r", "b", "l"]),
          ht = (t, e, n) =>
            dt(t, e, ["width", "height"], n && ((t) => Math.round(t))),
          gt = () => {},
          mt = (t) => {
            let e;
            const n = t ? lt : at,
          ...
          vt = (t, e) => {
            ...
            const { g: s, v: a, p: l } = e || {},
              c = function (e) {
                r(), ct(n), (n = i = void 0), (r = gt), t.apply(this, e);
              },
              d = (t) => (l && i ? l(i, t) : t),
              u = () => {
                r !== gt && c(d(o) || o);
          ...
          wt = (t, e, n) => {
            ...
            if (i && e && h(e)) {
              const t = e.match(bt) || [];
              for (s = t.length > 0; (o = t[r++]); ) s = !!n(i, o) && s;
            }
            return s;
          },
          xt = (t, e) => {
          ...
          St = (t, e) => (wt(t, e, (t, e) => t.add(e)), xt.bind(0, t, e)),
          ...
          Tt = (t, e, n) => {
            try {
              ...
              d(i[e])
                ? i.setProperty(e, n)
                : (i[e] = ((t, e) =>
                    !Et[t.toLowerCase()] && f(e) ? `${e}px` : e)(e, n));
            } catch (t) {}
          },
          Lt = (t) => "rtl" === o(t, "direction"),
          It = (t, e, n) => {
            const i = e ? `${e}-` : "",
              r = n ? `-${n}` : "",
              s = `${i}top${r}`,
          ...
          { round: kt } = Math,
          _t = { w: 0, h: 0 },
          At = (t) => (t ? { w: t.offsetWidth, h: t.offsetHeight } : _t),
          Mt = (t) => (t ? { w: t.clientWidth, h: t.clientHeight } : _t),
          zt = (t) => (t ? { w: t.scrollWidth, h: t.scrollHeight } : _t),
          Pt = (t) => {
            const e = parseFloat(o(t, "height")) || 0,
              n = parseFloat(o(t, "width")) || 0;
            return { w: n - kt(n), h: e - kt(e) };
          },
        ...
        const Bt = (t) => t.split(" "),
          ...
          qt = (t, e, n, o) => {
            ...
            const s = (() => {
              ...
              a = null != (r = s && o && o.S) ? r : s,
              l = (o && o.$) || !1,
              c = (o && o.C) || !1,
              u = [],
              p = s ? { passive: a, capture: l } : l;
            return (
              i(Bt(e), (e) => {
                const i = c
                  ? (o) => {
                      t.removeEventListener(e, i, l), n && n(o);
                    }
                  : n;
                C(u, Ft.bind(null, t, e, i, l)), t.addEventListener(e, i, p);
              }),
              L.bind(0, u)
            );
          },
          Wt = (t) => t.stopPropagation(),
          Nt = (t) => t.preventDefault(),
          Ht = { x: 0, y: 0 },
          Vt = (t) => {
            const e = t ? Dt(t) : 0;
            return e
          ...
          Te = {},
          Le = () => Te,
          { round: Ie, abs: ke } = Math,
          _e = "__osScrollbarsHidingPlugin";
        let Ae;
        const Me = (t, e, n, i) => {
            $(t, e);
            const o = Mt(e),
              r = At(e),
              s = Pt(n);
            return i && G(e), { x: r.h - o.h + s.h, y: r.w - o.w + s.w };
          },
          ze = (t, e) => {
            const n = "hidden";
            o(t, { overflowX: n, overflowY: n, direction: "rtl" }), j(t, 0);
            const i = Vt(t),
              r = Vt(e);
            j(t, -999);
            const s = Vt(e);
            return { i: i.x === r.x, n: r.x !== s.x };
          },
          Pe = (t, e) => {
            const n = St(t, Kt),
              i = Dt(t),
            ...
            Ae ||
              (Ae = (() => {
                const { body: t } = document,
                  e = X(`<div class="${Xt}"><div></div></div>`)[0],
                  n = e.firstChild,
                  [i, , s] = $t(),
                  [a, l] = r(
                    { o: Me(t, e, n), u: pt },
          ...
          je = (t, e) => (m(e) ? e.apply(0, t) : e),
          Be = (t, e, n, i) => {
            const o = d(i) ? n : i;
            return je(t, o) || e.apply(0, t);
          },
          Fe = (t, e, n, i) => {
            const o = d(i) ? n : i,
              r = je(t, o);
            return !!r && (x(r) ? r : e.apply(0, t));
          },
          qe = new WeakMap(),
          We = (t) => qe.get(t),
          Ne = (t, e) =>
            t
              ? e.split(".").reduce((t, e) => (t && I(t, e) ? t[e] : void 0), t)
              : void 0,
          He = (t, e, n) => (i) => [Ne(t, i), n || void 0 !== Ne(e, i)],
          Ve = (t) => {
            let e = t;
            return [
              () => e,
          ...
          Ge = (t) => {
            const e = De(),
              ...
              r = o && o.T,
              { elements: s } = n(),
              { host: a, padding: l, viewport: c, content: d } = s,
              u = x(t),
              p = u ? {} : t,
              { elements: f } = p,
              { host: h, padding: g, viewport: m, content: v } = f || {},
              y = u ? t : p.target,
              b = W(y, "textarea"),
              w = y.ownerDocument,
              S = w.documentElement,
              ...
              ot = {
                ...
                ft: (t, e) =>
                  F
                    ? ((t, e, n) => {
                        const i = z(t, "data-overlayscrollbars") || "";
                        return new Set(i.split(" ")).has(n);
                      })(Z, 0, e)
                    : ((t, e) => wt(t, e, (t, e) => t.contains(e)))(Z, t),
                _t: (t, e, n) => (F ? P(Z, Zt, e, n) : (n ? St : xt)(Z, t)),
              },
              rt = k(ot).reduce((t, e) => {
                const n = ot[e];
                return C(t, !(!n || H(n)) && n);
              }, []),
              st = (t) => (t ? E(rt, t) > -1 : null),
              { W: at, Z: lt, K: ct, J: dt, tt: ut, nt: pt } = ot,
              ft = [
                () => {
                  D(lt, Zt), D(lt, Qt), D(at, Qt), O && (D(S, Zt), D(S, Qt));
                },
              ],
              ht = b && st(lt);
            let mt = b ? at : N([ut, dt, ct, lt, at].find((t) => !1 === st(t)));
            const vt = q ? at : ut || dt;
            return [
              ot,
              () => {
                z(lt, Zt, F ? "viewport" : "host");
                const t = St(ct, "os-padding"),
                  e = St(dt, !F && oe),
                  n = St(ut, "os-content"),
                  o = O && !F ? St(H(y), se) : gt;
                if (
          ...
          Ue = (t, e) => {
            ...
            return (t) => {
              const { V: e } = De(),
                ...
                { gt: s } = t,
                a = (n || !e) && s;
              return a && o(n, { height: r ? "" : "100%" }), { vt: a, wt: a };
            };
          },
          Xe = (t, e) => {
            const [n, i] = e,
              { Z: s, K: a, J: l, ut: c } = t,
              [d, u] = r({ u: ft, o: It() }, It.bind(0, s, "padding", ""));
            return (t, e, r) => {
              let [s, p] = u(r);
              const { I: f, V: h } = De(),
                { bt: g } = n(),
          ...
          tn = { u: ut, o: { w: 0, h: 0 } },
          en = { u: pt, o: { x: Qe, y: Qe } },
          nn = (t, e, n) => (n ? St(t, e) : xt(t, e)),
          on = (t) => 0 === t.indexOf(Ze),
          rn = (t, e) => {
            const [n, i] = e,
              { Z: s, K: a, J: l, nt: c, ut: d, _t: u, it: p, et: f } = t,
              { k: h, V: g, I: m, A: v } = De(),
              y = Le()[_e],
              b = !d && !m && (v.x || v.y),
              w = p && d,
              [x, S] = r(tn, Pt.bind(0, l)),
              [E, C] = r(tn, zt.bind(0, l)),
              [O, T] = r(tn),
              [L, I] = r(tn),
              [k] = r(en),
              _ = (t, e) => {
                if ((o(l, { height: "" }), e)) {
                  const { St: e, K: i } = n(),
                    ...
                    c = Pt(s),
                    d = Mt(s),
                    u = "content-box" === o(l, "boxSizing"),
                    p = e || u ? i.b + i.t : 0,
                    f = !(v.x && u);
                  o(l, { height: d.h + c.h + (r.x && f ? a.x : 0) - p });
                }
              },
              A = (t, e) => {
                const n = m || t ? 0 : 42,
                  i = (t, i, r) => {
                    const s = o(l, t),
                      a = "scroll" === (e ? e[t] : s);
                    return [s, a, a && !m ? (i ? n : r) : 0, i && !!n];
                  },
                  [r, s, a, c] = i("overflowX", v.x, h.x),
                  [d, u, p, f] = i("overflowY", v.y, h.y);
                return {
                  Ct: { x: r, y: d },
                  $t: { x: s, y: u },
                  P: { x: a, y: p },
              ...
              M = (t, e, i, o) => {
                const { P: r, D: s } = t,
                  ...
                  { x: c, y: d } = r,
                  { M: u } = n(),
                  p = e ? "marginLeft" : "marginRight",
                  f = e ? "paddingLeft" : "paddingRight",
                  h = u[p],
                  g = u.marginBottom,
                  m = u[f],
                  v = u.paddingBottom;
                (o.width = `calc(100% + ${d + -1 * h}px)`),
                  (o[p] = -d + h),
                  (o.marginBottom = -c + g),
                  i &&
                    ((o[f] = m + (l ? d : 0)),
                    (o.paddingBottom = v + (a ? c : 0)));
              },
              [D, j] = y ? y.H(b, g, l, c, n, A, M) : [() => b, () => [gt]];
            return (t, e, r) => {
              const { vt: c, Ot: p, wt: h, xt: y, gt: b, yt: B } = t,
                { ht: F, bt: q } = n(),
                [W, N] = e("showNativeOverlaidScrollbars"),
                [H, V] = e("overflow"),
                R = W && v.x && v.y,
                $ = !d && !g && (c || h || p || N || b),
                Y = on(H.x),
              ...
              if (
                ...
                const p = {
                  ...
                  h = {
                    w: Je((w ? f.innerWidth : d.w + Je(a.w - o.w)) + n.w),
                    h: Je(
                      (w ? f.innerHeight + n.h : d.h + Je(a.h - o.h)) + n.h
                    ),
                  };
                (Q = L(h)),
                  (Z = O(
                    ((t, e) => {
                      const n = window.devicePixelRatio % 1 != 0 ? 1 : 0,
                        i = { w: Je(t.w - e.w), h: Je(t.h - e.h) };
                      return { w: i.w > n ? i.w : 0, h: i.h > n ? i.h : 0 };
                    })(p, h),
                    r
                  ));
              }
              const [tt, et] = Q,
                ...
                [ot, rt] = J,
                [st, at] = K,
                lt = { x: nt.w > 0, y: nt.h > 0 },
                ct =
                  (Y && G && (lt.x || lt.y)) ||
                  (Y && lt.x && !lt.y) ||
                  (G && lt.y && !lt.x);
              if (y || B || at || rt || et || it || V || N || $) {
                const t = {
                    marginRight: 0,
                    marginBottom: 0,
                    marginLeft: 0,
                ...
                d || M(e, q, n, t),
                  $ && _(e, F),
                  d ? (z(s, te, t.overflowX), z(s, ee, t.overflowY)) : o(l, t);
              }
              P(s, Zt, ne, ct), nn(a, ae, ct), !d && nn(l, ae, U);
              const [dt, ut] = k(A(R).Ct);
              return (
                i({
                  Ct: dt,
                  zt: { x: tt.w, y: tt.h },
          ...
          an = (t, e, n, o) => {
            let r = !1;
            const { Ht: s, Mt: a, Pt: l, Dt: c, Rt: d, kt: u } = o || {},
              p = vt(
                () => {
                  r && n(!0);
                },
              ...
              [f, g] = ((t, e, n) => {
                ...
                const s = (s) => {
                  if (n) {
                    const a = n.reduce((e, n) => {
                      if (n) {
                        const [i, o] = n,
                          r = o && i && (s ? s(i) : q(i, t));
                        r && r.length && o && h(o) && C(e, [r, o.trim()], !0);
                      }
                      return e;
                    }, []);
                    i(a, (n) =>
                  ...
                  (i(r, (n) => {
                    ...
                    if (e && (x || !S)) {
                      const e = !w,
                        d = w && O,
                        f = d && c && W(s, c),
                        h = (f ? !a(s, r, u, C) : e || d) && !l(n, !!f, t, o);
                      i(g, (t) => p.add(t)),
                        i(b, (t) => p.add(t)),
                        (y = y || h);
                    }
                    !e && S && O && !a(s, r, u, C) && (f.add(r), (v = v || T));
                  }),
                  p.size > 0 &&
                    g((t) =>
                      O(p).reduce(
                        (e, n) => (C(e, q(t, n)), W(n, t) ? C(e, n) : e),
                        []
                      )
                    ),
                  e)
          ...
          ln = 3333333,
          cn = (t) => t && (t.height || t.width),
          dn = (t, e, n) => {
            const { Bt: i = !1, Vt: o = !1 } = n || {},
              s = Le().__osSizeObserverPlugin,
              { B: a } = De(),
              l = X(`<div class="${le}"><div class="${de}"></div></div>`)[0],
              c = l.firstChild,
              d = Lt.bind(0, t),
              [u] = r({
                o: void 0,
              ...
              p = (t) => {
                ...
                if (i && c) {
                  const e = o ? t[0] : Lt(l);
                  j(l, e ? (a.n ? -ln : a.i ? 0 : ln) : ln), B(l, ln);
                }
                r || e({ vt: !o, Yt: o ? t : void 0, Vt: !!s });
              },
              f = [];
            let h = !!o && p;
            return [
                ...
                if (i) {
                  ...
                  C(
                    ...
                    qt(l, "scroll", (e) => {
                      const n = t(),
                        [i, o] = n;
                      o && (xt(c, "ltr rtl"), St(c, i ? "rtl" : "ltr"), p(n)),
                        Wt(e);
                    })
                  );
                }
                h && (St(l, ce), C(f, qt(l, "animationstart", h, { C: !!rt }))),
                  (rt || s) && $(t, l);
              },
            ];
          },
          ...
          hn = ["tabindex"],
          gn = ["wrap", "cols", "rows"],
          mn = ["id", "class", "style", "open"],
          vn = (t, e, n) => {
            let o, s, a;
            const { Z: l, J: c, tt: d, rt: u, ut: p, ft: g, _t: y } = t,
              { V: b } = De(),
              [w] = r({ u: ut, o: { w: 0, h: 0 } }, () => {
                const t = g(ae, ne),
                  e = g(re, ""),
              ...
              A = (t, e) => {
                const [, i] = w(),
                  o = { wt: i };
                return i && !e && (t ? n : O)(o), o;
              },
              M = (t, e, n) => {
                const i = { Ot: e };
                return e ? !n && O(i) : p || T(t), i;
              },
              [P, F, q] = d || !b ? un(l, L) : [gt, gt, gt],
              [W, N] = p ? [gt, gt] : dn(l, I, { Vt: !0, Bt: !0 }),
              [H, R] = an(l, !1, M, { Mt: mn, Ht: mn.concat(hn) }),
              $ = p && rt && new rt(I.bind(0, { vt: !0 }));
            return (
              $ && $.observe(l),
              T(),
              [
                () => {
                  P(), W(), a && a[0](), $ && $.disconnect(), H();
                },
                () => {
                  N(), F();
                },
                () => {
                  const t = {},
                    ...
                    i = a && a[1]();
                  return (
                    e && _(t, M.apply(0, C(e, !0))),
                    n && _(t, L.apply(0, C(n, !0))),
                    i && _(t, A.apply(0, C(i, !0))),
                    t
                  );
                },
                (t) => {
                  const [e] = t("update.ignoreMutation"),
                    [n, i] = t("update.attributes"),
                    [r, l] = t("update.elementEvents"),
                    [u, h] = t("update.debounce"),
                    g = (t) => m(e) && e(t);
                  if (
                    ((l || i) &&
                      (a && (a[1](), a[0]()),
                      (a = an(d || c, !0, A, {
                        ...
                        Dt: pn,
                        kt: (t, e) => {
                          const { target: n, attributeName: i } = t;
                          return (
                            (!(e || !i || p) &&
                              ((t, e, n) => {
                                const i = t && V(t, e),
          ...
          { round: wn } = Math,
          xn = (t, e) =>
            qt(t, "mousedown", qt.bind(0, e, "click", Wt, { C: !0, $: !0 }), {
              $: !0,
            }),
          Sn = (t, e, n, i, o, r) => {
            const { B: s } = De(),
              ...
              m = (t, e) => (n) => {
                const { Tt: u } = o(),
                  p = At(l)[h] - At(a)[h],
                  f = ((e * n) / p) * u[g],
                  m = Lt(c) && r ? (s.n || s.i ? 1 : -1) : 1;
                i[d] = t + f * m;
              };
            return qt(l, "pointerdown", (n) => {
              const o = V(n.target, `.${me}`) === a;
              if (
                ((t, e, n) => {
                  const i = e.scrollbars,
                    { button: o, isPrimary: r, pointerType: s } = t,
                    { pointers: a } = i;
                  return (
                    0 === o &&
                    r &&
                    i[n ? "dragScroll" : "clickScroll"] &&
                    (a || []).includes(s)
                  );
                })(n, t, o)
              ) {
                ...
                if (t) h(E);
                  ...
                  const t = Le().__osClickScrollPlugin;
                  t && C(O, t.O(h, c, E, w, S));
                }
                qt(
                  l,
                  "pointerup",
                  (t) => {
                    L(O), l.releasePointerCapture(t.pointerId);
                  },
                  { C: !0 }
                ),
                  l.setPointerCapture(n.pointerId);
              }
            });
          },
          { min: En, max: Cn, abs: On, round: Tn } = Math,
          Ln = (t, e, n, i) => {
            if (i) {
              const t = n ? "x" : "y",
                { Tt: e, zt: o } = i,
                r = o[t],
                s = e[t];
              return Cn(0, En(1, r / (r + s)));
            }
            const o = n ? "w" : "h",
              r = At(t)[o],
              s = At(e)[o];
            return Cn(0, En(1, r / s));
          },
          In = (t, e, n) => {
            const { N: r } = De(),
              { scrollbars: s } = r(),
              { slot: a } = s,
              { ct: l, W: c, Z: d, J: u, lt: p, ot: f, it: h, ut: m } = e,
              { scrollbars: v } = p ? {} : t,
              { slot: y } = v || {},
              b = Fe([c, d, u], () => (m && h ? c : d), a, y),
              w = (t, e, n) => {
                const o = n ? St : xt;
                i(t, (t) => {
                  o(t.Xt, e);
              ...
              E = (t, e, n) => {
                ...
                x(t, (t) => {
                  ...
                  return [
                    ...
                    {
                      transform:
                        a == a ? `translate${i}(${(100 * a).toFixed(3)}%)` : "",
                    },
                  ];
                });
              },
              ...
              [
                {
                  ...
                  Zt: _,
                  Jt: { Kt: I, Qt: M, tn: x.bind(0, I) },
                  nn: { Kt: k, Qt: z, tn: x.bind(0, k) },
                },
                () => {
                  $(b, I[0].Xt),
                    $(b, k[0].Xt),
          ...
          kn = (t, e, n) => {
            m(t) && t(e || void 0, n || void 0);
          },
          _n = (t, e, n) => {
            const { F: o, N: r, Y: s, j: a } = De(),
              l = Le(),
              c = x(t),
              p = c ? t : t.target,
              f = We(p);
            if (e && !f) {
              let f = !1;
              const h = (t) => {
                  const e = Le().__osOptionsValidationPlugin,
                    n = e && e.O;
                  return n ? n(t, !0) : t;
                },
                g = _({}, o(), h(e)),
                ...
                [b, w, x] = ((t, e) => {
                  const n = He(e, {}),
                    ...
                    [d, u, p] = Ge(t),
                    f = ((t, e) => {
                      const { W: n, J: o, _t: r, ut: s } = t,
                        { I: a, A: l, V: c } = De(),
                        d = !a && (l.x || l.y),
                        u = [Ue(t, e), Xe(t, e), rn(t, e)];
                      return (t, e, a) => {
                        const l = sn(
                            _(
                              {
                    ...
                    h = (t, e, n) => {
                      const i = k(t).some((e) => t[e]),
                        o = i || !A(e) || n;
                      return o && a("u", [t, e, n]), o;
                    },
                    [g, m, v, y] = vn(d, c, (t) => h(f(n, t), {}, !1)),
                    b = l.bind(0);
                  return (
                    (b.jt = (t) => r("u", t)),
                    (b.Nt = () => {
                ...
                [S, E, C] = ((t, e, n, i) => {
                  ...
                  const d = Ve({}),
                    ...
                    [S, E, C] = In(
                      ...
                      ((t, e) => (n, i, o, r, s, a) => {
                        ...
                        return L.bind(0, [
                          ...
                          qt(l, "pointerleave pointercancel", () => {
                            i(we);
                          }),
                          qt(
                            l,
                    ...
                    { Z: O, J: T, ot: I, st: k, ut: _, it: A } = n.qt,
                    { Jt: M, nn: z, Zt: P, Ut: D, Wt: F } = S,
                    { tn: q } = M,
                    { tn: W } = z,
                    N = (t) => {
                      const { Xt: e } = t,
                      ...
                      return [
                        n,
                        {
                          transform: n ? `translate(${j(I)}px, ${B(I)}px)` : "",
                        },
                      ];
                    },
                    V = (t, e) => {
                  ...
                  return (
                    ...
                    [
                      (t, i, a) => {
                        const { At: d, Lt: u, It: p, yt: f } = a,
                          { A: h } = De(),
                          g = He(e, t, i),
                          m = n(),
                          { Tt: v, Ct: y, bt: b } = m,
                          [w, x] = g("showNativeOverlaidScrollbars"),
                          [S, E] = g("scrollbars.theme"),
                          [C, O] = g("scrollbars.visibility"),
                          [T, L] = g("scrollbars.autoHide"),
                          [I] = g("scrollbars.autoHideDelay"),
                          [k, _] = g("scrollbars.dragScroll"),
                          [M, z] = g("scrollbars.clickScroll"),
                          j = d || u || f,
                          B = p || O,
                          q = w && h.x && h.y,
                          W = (t, e) => {
                ...
                P = {
                  ...
                  elements() {
                    const {
                      ...
                      { Jt: a, nn: l } = E.qt,
                      c = (t) => {
                        const { Ft: e, Gt: n, Xt: i } = t;
                        return { scrollbar: i, track: n, handle: e };
                      },
                      d = (t) => {
                        const { Kt: e, Qt: n } = t,
                          i = c(e[0]);
              ...
              return (
                ...
                i(k(l), (t) => kn(l[t], 0, P)),
                ((t, e, n) => {
                  const { nativeScrollbarsOverlaid: i, body: o } = n || {},
                    { A: r, I: s } = De(),
                    { nativeScrollbarsOverlaid: a, body: l } = e,
                    c = null != i ? i : a,
                    p = d(o) ? l : o,
                    f = (r.x || r.y) && c,
                    h = t && (u(p) ? !s : p);
                  return !!f || !!h;
                })(w.qt.it, r().cancel, !c && t.cancel)
                  ? (z(!0), P)
                  : (w.Nt(),
                    E.Nt(),
                    y("initialized", [P]),
        ...
        An(function () {
          setTimeout(() => {
            ...
            document.addEventListener(
              "focus",
              function (n) {
                var i = Mn(n.target, ".main-nav__link");
                if (
                  i.length > 0 &&
                  e.test(i.className) &&
                  Mn(n.target, ".nav--main").length > 0
                )
                  for (
                    var o = Mn(n.target, ".main-nav__item"), r = 0;
                    r < o.length;
                    r++
                  )
                    o[r].classList.add(t);
              ...
              document.addEventListener(
                ...
                function (n) {
                  var i = Mn(n.target, ".main-nav__link");
                  if (e.test(i.className))
                    for (
                      var o = document.querySelectorAll("." + t), r = 0;
                      r < o.length;
                      r++
                    )
                      o[r].classList.remove(t);
                },
                !0
              ),
              document
                ...
                .addEventListener("click", function (t) {
                  ...
                  var e = Mn(t.target, ".main-nav__link");
                  if (
                    e.length > 0 &&
                    ...
                    var n = Mn(t.target, ".main-nav__item--has-child");
                    n.length > 0 &&
                      (console.log("parents"),
                      console.log(n),
                      t.preventDefault(),
        ...
        n(4783)(function () {
          document.querySelector("#map") &&
            ...
            ymaps.ready(function () {
              var t = new ymaps.Map(
                "map",
                { center: [55.768355, 37.717474], zoom: 12 },
                { searchControlProvider: "yandex#search" }
              );
              ymaps.templateLayoutFactory.createClass(
                "<div class='my-hint'><span>{{ properties.text }}</span></div>",
                {
                  getShape: function () {
                ...
                t.geoObjects.add(myPlacemark).add(myPlacemarkWithContent);
            }));
        });
      },
      4014: function (t, e, n) {
      ...
      1516: function (t, e, n) {
        n(4783)(function () {
          function t() {
            document
              .getElementById("off-canvas")
              .classList.toggle("off-canvas--open");
          }
          document.addEventListener("click", function (e) {
            "off-canvas" === e.target.dataset.toggle &&
              (e.preventDefault(), t()),
              "off-canvas" === e.target.dataset.toggleNative && t();
          }),
      ...
      2103: function (t, e, n) {
        n(4783)(function () {
          const t = document.querySelectorAll(".page-links");
          for (wrap of t)
            wrap.addEventListener("click", function (t) {
              console.log(t.target);
              const e = this.querySelectorAll(".page-links__link");
              for (link of e) link.classList.remove("active");
      ...
      8542: function (t, e, n) {
        n(4783)(function () {
          const t = document.querySelectorAll(".page-select__input");
          for (var e of t)
            e.addEventListener("change", function () {
              console.log(this.value),
                console.log(document.location.origin),
                (document.location.href =
                  document.location.origin + this.value);
            });
        });
      },
      3401: function (t, e, n) {
        ...
        n(6178),
          i(function () {
            const t = ".product-options__amount",
              e = ".product-options__label--clear",
              n = document.querySelector(e),
              i = document.querySelector(".product-options__lbl-add"),
              o = document.querySelector(".product-options__lbl-change");
            var r = document.querySelector(e + " button");
            r &&
              r.addEventListener("click", function (e) {
                console.log("click"), e.stopPropagation();
                var r = document.querySelectorAll(
                  ".form--options .field-checkbox__input"
                );
                for (input of (console.log(r), r))
                  (input.checked = !1),
                    input.dispatchEvent(new Event("change"));
                r.length > 0 &&
                  ((document.querySelector(t).innerText = "0 доп. опции"),
            ...
            for (input of s)
              input.checked && (a += 1),
                input.addEventListener("change", function (t) {
                  console.log("change");
                  var e = this.closest(".product-options__item");
                  console.log(e),
                    this.checked
                      ? e.classList.add("product-options__item--checked")
                      : e.classList.remove("product-options__item--checked");
                });
            a > 0 &&
              ((document.querySelector(t).innerText = "".concat(
                a,
                "  доп. опции"
              )),
      ...
      4229: function (t, e, n) {
        ...
        n(6178),
          i(function () {
            var t = document.getElementsByClassName("profile__form-clear")[0];
            t &&
              t.addEventListener("click", function (t) {
                t.preventDefault();
                var e = this.closest(".profile__form");
                if (e) {
                  var n = e.getElementsByClassName("field-text");
                  for (var i of n) {
                    let t = i.getElementsByTagName("input")[0];
      ...
      7619: function (t, e, n) {
        ...
        function f(t, e, n) {
          if (!(t >= e && t <= n))
            throw Error(
              "Invalid Rating, expected value between " + e + " and " + n
            );
          return t;
        }
        function h(t, e) {
        ...
        var m = function (t) {
          ...
          v = /^#([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})$/i;
        function y(t) {
        ...
        function b(t, e, n) {
          var i = (n / 100) * (e - t);
          return (
            1 === (i = Math.round(t + i).toString(16)).length && (i = "0" + i),
            i
          );
        }
        function w(t, e, n) {
          if (!t || !e) return null;
          (n = g(n) ? n : 0), (t = y(t)), (e = y(e));
          var i = b(t.r, e.r, n),
            o = b(t.b, e.b, n);
          return "#" + i + b(t.g, e.g, n) + o;
        }
        var x = {};
        function S(t) {
          return x[t] || (x[t] = new String(t));
        }
        var E = new WeakMap();
        function C(t, e, n) {
          n = S(n);
          var i = E.get(t);
          i || E.set(t, (i = new WeakMap()));
          var o = i.get(n);
          o || i.set(n, (o = new Map()));
          var r = o.get(e);
          if (r) return r;
        ...
        var O = m(window.Event)
            ...
            : function (t) {
                ...
                return s.initEvent(t, i, r), s;
              },
          T = m(window.CustomEvent)
            ? window.CustomEvent
            : ((T.prototype = Object.create(O.prototype)), T),
          L = {
            trigger: function (t, e) {
              var n = { bubbles: !0 };
              return (
                g(e)
                  ? this.node.dispatchEvent(new T(t, s({ detail: e }, n)))
                  : this.node.dispatchEvent(new O(t, n)),
                this
              );
            },
            on: function (t, e) {
              return this.node.addEventListener(t, C(this.node, e, t)), this;
            },
            off: function (t, e) {
              return (
                this.node.removeEventListener(t, C.get(this.node, e, t)), this
              );
            },
          },
          I = /^rateyo(.+)$/;
        function k(t, e, n) {
          var i = t.className.trim(),
            ...
            r = {};
          if (
            ((o = o.reduce(function (t, e, n) {
              return r.hasOwnProperty(e) || (t.push(e), (r[e] = n)), t;
            }, [])),
            e === k.add)
          ) {
        ...
        (k.add = "add"),
          ...
          (_.prototype = {
            ...
            addClass: function (t) {
              return k(this.node, k.add, t), this;
            },
            removeClass: function (t) {
              return k(this.node, k.remove, t), this;
            },
            appendTo: function (t) {
              return (_.isEl(t) ? t.node : t).appendChild(this.node), this;
            },
            css: function (t, e) {
              return (this.node.style[t] = e), this;
            },
            width: function (t) {
              if (!g(t)) return this.node.getBoundingClientRect().width;
              this.css(
                "width",
                t +
                  ((function (t) {
            ...
            find: function (t) {
              return D(this.node.querySelectorAll(t));
            },
            attr: function (t) {
              for (var e in t)
                t.hasOwnProperty(e) && this.node.setAttribute(e, t[e]);
              return this;
            },
            ...
            dataAttrOptions: function () {
              var t = this.node.dataset;
              return Object.keys(t).reduce(function (e, n) {
                var i = n.match(I);
                if (!i) return e;
                var o = i[1];
                return (e[o[0].toLowerCase() + o.slice(1)] = t[n]), e;
              }, {});
            },
          }),
          (_.prototype = s(s({}, _.prototype), L)),
          (_.isEl = function (t) {
            return t instanceof _;
          }),
          (A.isCollection = function (t) {
            return t instanceof A;
          }),
          (A.prototype = {});
        var M = function (t) {
          if (!_.prototype.hasOwnProperty(t)) return "continue";
          A.prototype[t] = function () {
            for (var e = arguments.length, n = new Array(e), i = 0; i < e; i++)
              n[i] = arguments[i];
            return (
              this.collection.forEach(function (e) {
                return _.isEl(e) && e[t].apply(e, n);
              }),
              this
            );
          };
        };
        for (var z in _.prototype) M(z);
        var P = new DOMParser();
        function D(t) {
          var e;
          return (
            (t =
              ((function (t) {
                ...
                ((e = t),
                P.parseFromString(e.trim(), "text/html").body.childNodes)) ||
              t),
            _.isEl(t) || A.isCollection(t)
              ? t
        ...
        function B(t) {
          ...
          var o,
            ...
            b = D(document.createElement("div"))
              ...
              .appendTo(i),
            x = D(document.createElement("div"))
          ...
          function T(t) {
            ...
            var n = t / o,
              i = n * h;
            n > 1 && (i += (Math.ceil(n) - 1) * v),
              M(e.ratedFill),
              (i = e.rtl ? 100 - i : i) < 0 ? (i = 0) : i > 100 && (i = 100),
              S.css("width", i + "%");
          }
          function L() {
            (y = r * e.numStars + m * (e.numStars - 1)),
              (h = (r / y) * 100),
              (v = (m / y) * 100),
              i.width(y),
              T();
          ...
          function I(t) {
            var n = (e.starWidth = t);
            return (
              (r = window.parseFloat(e.starWidth.replace("px", ""))),
              x.find("svg").attr({ width: e.starWidth, height: n }),
              S.find("svg").attr({ width: e.starWidth, height: n }),
              L(),
              i
            );
          }
          function k(t) {
            return (
              (e.spacing = t),
              (m = parseFloat(e.spacing.replace("px", ""))),
          ...
          function _(t) {
            return (
              (e.normalFill = t),
              (e.rtl ? S : x).find("svg").attr({ fill: e.normalFill }),
              i
            );
          }
          var A = e.ratedFill;
          function M(t) {
            if (e.multiColor) {
              var n = ((C - E) / e.maxValue) * 100,
                o = e.multiColor || {};
              t = w(o.startColor || c, o.endColor || d, n);
            } else A = t;
            return (
              (e.ratedFill = t),
              (e.rtl ? x : S).find("svg").attr({ fill: e.ratedFill }),
              i
            );
          }
          function z(t) {
            (t = !!t), (e.rtl = t), _(e.normalFill), T();
          }
          function P(t) {
            (e.multiColor = t), M(t || A);
          }
          function F(t) {
            (e.numStars = t),
              (o = e.maxValue / e.numStars),
              x.empty(),
              S.empty();
            for (var n = 0; n < e.numStars; n++)
              D(e.starSvg || a).appendTo(x), D(e.starSvg || a).appendTo(S);
            return I(e.starWidth), _(e.normalFill), k(e.spacing), T(), i;
          }
          function q(t) {
            return (
              (e.maxValue = t),
          ...
          function W(t) {
            return (e.precision = t), Y(e.rating), i;
          }
          function N(t) {
            return (e.halfStar = t), i;
          }
          function H(t) {
            return (e.fullStar = t), i;
          }
          function V(t) {
            var n = t % o,
              i = o / 2,
          ...
          function R(t) {
            ...
            return e.rtl && (a = r - a), parseFloat(a);
          }
          function $(t) {
            return (
              (e.readOnly = t),
          ...
          function Y(t) {
            ...
            return (
              "string" == typeof n &&
                ("%" === n[n.length - 1] &&
                  ((n = n.substr(0, n.length - 1)), q((o = 100))),
                (n = parseFloat(n))),
              f(n, E, o),
              ...
              (e.rating = n),
              T(),
              O && i.trigger("rateyo.set", { rating: n }),
              i
            );
          }
          function G(t) {
          ...
          function X(t) {
            return (e.onChange = t), i;
          }
          function K(t) {
            if (e.hover) {
              var n = R(t).toFixed(e.precision),
                o = e.maxValue;
              T((n = p(parseFloat(n), E, o))),
                i.trigger("rateyo.change", { rating: n });
            }
          }
          function J() {
            !u() &&
              e.hover &&
              (T(), i.trigger("rateyo.change", { rating: e.rating }));
          }
          function Z(t) {
            var i = R(t).toFixed(e.precision);
            (i = parseFloat(i)), n.rating(i);
          }
          function Q(t, i) {
            e.onInit &&
              "function" == typeof e.onInit &&
              e.onInit.apply(this, [i.rating, n]);
          }
          function tt(t, i) {
            e.onChange &&
              "function" == typeof e.onChange &&
              e.onChange.apply(this, [i.rating, n]);
          }
          function et(t, i) {
            e.onSet &&
              "function" == typeof e.onSet &&
              e.onSet.apply(this, [i.rating, n]);
          }
          function nt() {
            i.on("mousemove", K)
              .on("mouseenter", K)
          ...
          function it() {
            i.off("mousemove", K)
              ...
              .off("click", Z)
              .off("rateyo.init", Q)
              .off("rateyo.change", tt)
              .off("rateyo.set", et);
          }
          (this.rating = function (t) {
            return g(t) ? (Y(t), i) : e.rating;
          }),
            ...
            (O = !0),
            i.trigger("rateyo.init", { rating: e.rating });
        }
        Object.defineProperty(B.prototype, "on", {
          value: function (t, e) {
            return D(this.node).on(t, e), this;
          },
        }),
          Object.defineProperty(B.prototype, "off", {
            value: function (t, e) {
              return D(this.node).off(t, e), this;
            },
          }),
          Object.defineProperty(B, "has", {
            value: function (t) {
              return j.has(t);
            },
          }),
          Object.defineProperty(B, "get", {
            value: function (t) {
              return j.get(t);
            },
          }),
        ...
        var F = B;
        n(4783)(function () {
          var t = document.querySelectorAll(".rating__stars--view");
          for (var e of t)
            e.dataset.value &&
              F(e, {
      ...
      802: function (t, e, n) {
        ...
        var s = n(3096);
        i(function () {
          const t = document.getElementsByClassName("search-form")[0];
          function e() {
            let t = document.querySelectorAll(".search-form");
            if (document.documentElement.clientWidth < 1024)
              for (form of t) c(form);
            else for (form of t) form.classList.remove("active");
          }
          t.navMobileOpen && l(t),
            document
              .getElementById("btnSearch")
              .addEventListener("click", function (t) {
                let e = o(this, ".search-form");
                if (e.length > 0) {
                  if (e[0].navMobileOpen) return;
                  e[0].classList.contains("active")
                    ? (c(e[0]), e[0].classList.remove("active"))
                    : (l(e[0]),
                      e[0].classList.add("active"),
                      e[0].querySelector(".search-form__input").focus());
                }
                t.stopPropagation();
              }),
            document.addEventListener("click", (n) => {
              if (n.target.classList.contains("search-form")) {
                if (n.target.classList.contains("active")) return;
              } else {
                let e = o(n.target, ".search-form");
                if (e.length > 0) {
                  if (e[0].classList.contains("active")) return;
                } else if (t.navMobileOpen) return;
              }
              e();
            }),
          ...
          var n = document.querySelectorAll(".search-form"),
            i = document.documentElement.clientWidth;
          window.addEventListener(
            "resize",
            s(function () {
              var t = document.documentElement.clientWidth;
              if (i != t) for (var e of n) c(e);
              i = t;
            }, 200)
          );
        });
        var a = !1,
          l = function (t) {
            console.log("mobileSearchOpen searchFormEl", t);
            var e = document.documentElement.clientWidth;
            if ((t.navMobileOpen, e < 1024)) {
              var n = r(t)[0],
                i = document.getElementsByClassName("off-canvas__toggler")[0];
              console.log("[mobileSearchOpen] closeBtn", i);
              var o = r(i)[0];
              console.log(e), console.log(o);
              var s = t.querySelector(".search-form__input-wrapper");
              (t.style.transform = "translateX(".concat(o - n, "px)")),
                (s.style.width = o + "px"),
        ...
        function c(t) {
          ...
          var e = t.querySelector(".search-form__input-wrapper");
          a &&
            e.addEventListener(
              "transitionend",
              function (t) {
        ...
        (e.mobileSearchOpen = l), (e.mobileSearchClose = c);
      },
      9984: function (t, e, n) {
        n(4783)(function () {
          const t = "sort__item--active";
          var e = document.querySelectorAll(".sort");
          for (sort of e) {
            var n = sort.querySelectorAll(".sort__item");
            for (item of n)
              item.addEventListener("click", function (e) {
                if ((console.log(n), !this.classList.contains(t))) {
                  for (el of n) console.log(el), el.classList.remove(t);
                  this.classList.add(t);
                }
              });
          }
          const i = "sort-asc";
          var o = document.querySelectorAll(".btn--sort");
          for (btn of o)
      ...
      2500: function (t, e, n) {
        ...
        n(3180),
          o(function () {
            try {
              !(function () {
                var t = document.querySelectorAll(".switcher__wrapper");
                if (t.length > 0)
                  for (switcher of t) {
                    r[switcher.id] = {};
                    var e = switcher.querySelectorAll(
                      ".switcher__select .switcher__item"
                    );
                    for (i = 0; i < e.length; i++)
                      r[switcher.id][e[i].dataset.name] = e[i].innerText;
                  }
              })(),
                s("lang");
              var t = document.querySelectorAll(".switcher__wrapper");
              for (switcher of t) {
                var e = switcher.querySelectorAll(".switcher__item");
                for (i = 0; i < e.length; i++)
                  e[i].addEventListener("click", function (t) {
                    ...
                    t.preventDefault(),
                      this.dataset &&
                        this.dataset.name &&
                        "" != this.dataset.name &&
                        ((e = "lang"), (n = this.dataset.name), a(e, n), s(e));
                  });
              }
            } catch (t) {
              console.log(
            ...
            try {
              !(function () {
                active = l("lang");
                let t = document.querySelectorAll(".lang-btns");
                if (t.length > 0)
                  for (let e = 0; e < t.length; e++) {
                    let n = t[e].querySelectorAll(".btn--lang");
                    "undefined" != typeof active &&
                      t[e]
                        .querySelector(".btn--lang[data-name=" + active + "]")
        ...
        function s(t) {
          var e,
            n = document.querySelectorAll(".switcher__wrapper");
          n.length > 0 &&
            ((void 0 !== (e = l(t)) && "" != e && "undefined" != e) ||
              a(t, (e = Object.keys(r[Object.keys(r)[0]])[0])));
          for (var i = 0; i < n.length; i++) {
            n[i].querySelector(".switcher__value span").textContent =
              r[n[i].id][e];
            for (
              var o = n[i].querySelectorAll(".switcher__item"), s = 0;
              s < o.length;
              s++
            )
              o[s].dataset.name === e
                ? o[s].classList.contains("switcher__item--active") ||
                  o[s].classList.add("switcher__item--active")
                : o[s].classList.remove("switcher__item--active");
          }
        }
        function a(t, e, n) {
          void 0 === n && (n = {}),
            (n = { ...n, path: "/" }).expires instanceof Date &&
              (n.expires = n.expires.toUTCString());
          let i = encodeURIComponent(t) + "=" + encodeURIComponent(e);
          for (let t in n) {
            i += "; " + t;
            let e = n[t];
            !0 !== e && (i += "=" + e + ";");
        ...
        function l(t) {
          ...
          var n;
          return e && (n = decodeURIComponent(e[1])), n;
        }
      },
      1363: function (t, e, n) {
        const i = n(4783);
        ...
        i(function () {
          var t = 0;
          let e = document.querySelectorAll(".tabs__select");
          for (tabSelectEl of e)
            tabSelectEl.value = tabSelectEl.options[0].value;
          function n() {
            if (!(t || document.documentElement.clientWidth > 767)) {
              for (tabSelectEl of e)
                tabSelectEl.addEventListener("change", function (t) {
          ...
          n(), window.addEventListener("resize", o(n, 100));
        });
      },
      6264: function (t, e, n) {
        const i = n(4783);
              ...
              function n(n) {
                return function (i) {
                  if ((console.log("btnGoClick function"), t)) {
                    ...
                    a.parentNode.insertBefore(s, a), (t = !0);
                    var l = i.target.closest(".video-yt");
                    (firstVideoIndexClicked = l),
                      console.log("firstVideoIndexClicked = "),
                      console.log(firstVideoIndexClicked);
                  }
                };
              }
              var i = document.querySelectorAll(".video-yt");
              for (let s = 0; s < i.length; s++) {
                console.log(i[s]);
                var o = i[s].querySelector(".btn-play"),
                  r = i[s].querySelector(".video-yt__frame");
                r &&
                  o &&
                  ((r.dataset.index = s), o.addEventListener("click", n(s))),
                  r &&
                    r.addEventListener("custom-stop-video", function (t) {
                      e &&
              ...
              (window.onPlayerReady = function (t) {
                ...
                (window.onPlayerStateChange = function (t) {
                  ...
                  var n = t.target.g.closest(".video-yt"),
                    i = n.querySelector(".video-yt__frame"),
                    o = n.querySelector(".video-yt__poster"),
                    r = i.dataset.index;
                  t.data == YT.PlayerState.ENDED
                    ? (e[r].stopVideo(),
                      o.classList.remove("video-yt__poster--hidden"),
                      i.classList.add("video-hidden"))
                    : (t.data != YT.PlayerState.PLAYING &&
                        t.data != YT.PlayerState.BUFFERING) ||
                      (i.classList.remove("video-hidden"),
                      o.classList.add("video-yt__poster--hidden"),
                      e[r].playVideo());
                }),
          ...
          for (btn of t)
            btn.addEventListener("click", function (t) {
              ...
              e.classList.contains("playing")
                ? o.pauseVideo(e.querySelector("video"))
                : (console.log("play"),
                  console.log(e.querySelector("video")),
                  o.playVideo(e.querySelector("video")));
            });
          var e = document.querySelectorAll(".video video");
          for (video of e) o.addEvents(video);
        });
      },
      17: function (t, e, n) {
        const i = n(4783),
        ...
        i(function () {
          console.log("script.js"), o(".add-info__text.ellipsis");
          ...
          document.addEventListener(
            ...
            s(),
            (window.onresize = r(s, 500));
        });
      },
      4876: function (t, e, n) {
        n(4783)(function () {
          var t = document.querySelector("select[data-select-anchor]");
          t &&
            t.addEventListener("change", function (t) {
              var e = document.querySelector(this.value);
              if (e) {
                var n = document.querySelector(".page-header").clientHeight;
                o(e.getBoundingClientRect().top + window.scrollY - n - 10, 300);
              }
            });
          var e = document.querySelectorAll("[data-tabs-anchor]");
          if (
            (console.log(e),
            0 == document.getElementsByClassName("onepage-wrapper").length)
          )
            for (var n of e)
          ...
          function i(t) {
            if ((t.preventDefault(), t.target.dataset.anchor)) {
              var e = document.querySelector(t.target.dataset.anchor);
              if (e) {
                var n = document.querySelector(".page-header").clientHeight;
                o(e.getBoundingClientRect().top + window.scrollY - n - 10, 300);
              }
          ...
          function o(t, e) {
            ...
            null == e && (e = 500),
              ...
              window.requestAnimationFrame(function o(r) {
                var s = r - (i = i || r);
                n < t
                  ? window.scrollTo(0, ((t - n) * s) / e + n)
                  : window.scrollTo(0, n - ((n - t) * s) / e),
                  s < e
      ...
      9828: function (t) {
        var e = function (t) {
          ...
          o = function (t, e) {
            for (
              var o = t.innerHTML.split(" "), r = e * n(t), s = i(t);
              s > r && o.length > 0;

            )
              o.pop(), (t.innerHTML = o.join(" ") + "..."), (s = i(t));
          };
        t.exports = function (t) {
          var n;
          if (
      ...
      953: function (t) {
        t.exports = function (t) {
          let e = (curTop = 0);
          if ((console.log(t.offsetParent), t.offsetParent))
            do {
              ...
              function a() {
                ...
                (this.add = function (t) {
                  ...
                  (this.call = function (i) {
                    for (t = 0, e = n.length; t < e; t++) n[t].call(this, i);
                  }),
                ...
                !(function (t, n) {
                  if (t)
                    if (t.resizedAttached) t.resizedAttached.add(n);
                      ...
                      (l.className = "resize-sensor-expand"), o(l, r);
                      var c = document.createElement("div");
                      o(c, s), l.appendChild(c);
                      var d = document.createElement("div");
                      (d.className = "resize-sensor-shrink"), o(d, r);
                      var u = document.createElement("div");
                      o(u, s),
                        o(u, { width: "200%", height: "200%" }),
                        d.appendChild(u),
                        t.resizeSensor.appendChild(l),
                        t.resizeSensor.appendChild(d),
                        t.appendChild(t.resizeSensor);
                      var p,
                        f,
                        h = window.getComputedStyle(t),
                        g = h ? h.getPropertyValue("position") : null;
                      "absolute" !== g &&
                        "relative" !== g &&
                        "fixed" !== g &&
                      ...
                      var S = function () {
                          (f = 0),
                            p &&
                              ((v = m.width),
                              (y = m.height),
                              t.resizedAttached && t.resizedAttached.call(m));
                        },
                        E = function () {
                          (m = i(t)),
                            (p = m.width !== v || m.height !== y) &&
                              !f &&
                              (f = e(S)),
                            x();
                        },
              ...
              (r.detach = function (t, e) {
                n(t, function (t) {
                  t &&
                    ((t.resizedAttached &&
                      "function" == typeof e &&
                      (t.resizedAttached.remove(e),
                      t.resizedAttached.length())) ||
                      (t.resizeSensor &&
                        (t.contains(t.resizeSensor) &&
        ...
        const r = (() => {
          ...
          class n {
              ...
              return (
                this.isSidebarFitsViewport()
                  ...
                  ? ((t.translateY = t.containerBottom - e),
                    (o = "CONTAINER-BOTTOM"))
                  : e + t.translateY <= i
                  ? ((t.translateY = i - e), (o = "VIEWPORT-BOTTOM"))
            ...
            _getAffixTypeScrollingUp() {
              ...
              return (
                n <= t.translateY + t.containerTop
                  ? ((t.translateY = n - t.containerTop), (o = "VIEWPORT-TOP"))
                  : t.containerBottom <= i
                  ? ((t.translateY = t.containerBottom - e),
                    (o = "CONTAINER-BOTTOM"))
                  : this.isSidebarFitsViewport() ||
              ...
              if (void 0 !== t) {
                ...
                switch (t) {
                  ...
                  case "VIEWPORT-UNBOTTOM":
                    let t = this._getTranslate(0, i.translateY + "px");
                    e.inner = t
                      ? { transform: t }
                      : {
                          position: "absolute",
            ...
            stickyPosition(e) {
              if (!this._breakpoint) {
                ...
                if ((this.affixedType != i || e) && i) {
                  let e =
                    "affix." + i.toLowerCase().replace("viewport-", "") + t;
                  n.eventTrigger(this.sidebar, e),
                    "STATIC" === i
                      ? n.removeClass(this.sidebar, this.options.stickyClass)
                      : n.addClass(this.sidebar, this.options.stickyClass);
                  for (let t in o.outer) {
                    let e = "number" == typeof o.outer[t] ? "px" : "";
                    this.sidebar.style[t] = o.outer[t] + e;
                  }
                  for (let t in o.inner) {
                    let e = "number" == typeof o.inner[t] ? "px" : "";
                    this.sidebarInner.style[t] = o.inner[t] + e;
                  }
                  let r =
                    "affixed." + i.toLowerCase().replace("viewport-", "") + t;
                  n.eventTrigger(this.sidebar, r);
                } else
                  this._initialized &&
            ...
            destroy() {
              ...
              for (let t in e.outer) this.sidebar.style[t] = e.outer[t];
              for (let t in e.inner) this.sidebarInner.style[t] = e.inner[t];
              this.options.resizeSensor &&
                "undefined" != typeof ResizeSensor &&
            ...
            static extend(t, e) {
              var n = {};
              for (let i in t) void 0 !== e[i] ? (n[i] = e[i]) : (n[i] = t[i]);
              return n;
            }
      ...
      4148: function (t, e, n) {
        var i = n(6178),
          ...
          r = function (t) {
            console.log("onPlay"), i(t, ".video", !0).classList.add("playing");
          };
        o.onPlay = r;
        var s = function (t) {
          i(t, ".video", !0).classList.remove("playing"), (t.controls = !1);
        };
        o.onStop = s;
        var a = function (t) {
          i(t, ".video", !0).classList.remove("playing"), (t.controls = !1);
          ...
          return (
            ...
            (function (t, e, n) {
              ...
              function b(e) {
                var n = o,
                  i = r;
                return (o = r = void 0), (d = e), (a = t.apply(i, n));
              }
              function w(t) {
              ...
              function x(t) {
                var n = t - c;
                return void 0 === c || n >= e || n < 0 || (p && t - d >= s);
              }
              function S() {
                var t = g();
                if (x(t)) return E(t);
              ...
              return (
                ...
                m(n) &&
                  ((u = !!n.leading),
                  (s = (p = "maxWait" in n) ? f(v(n.maxWait) || 0, e) : s),
      ...
      1343: function () {
        !(function () {
          ...
          function m(t, e, n) {
            var i = (n / 100) * (e - t);
            return (
              1 === (i = Math.round(t + i).toString(16)).length &&
                (i = "0" + i),
              i
            );
          }
          function v(t, e, n) {
            if (!t || !e) return null;
            (n = p(n) ? n : 0), (t = g(t)), (e = g(e));
            var i = m(t.r, e.r, n),
              o = m(t.b, e.b, n);
            return "#" + i + m(t.g, e.g, n) + o;
          }
          var y = {};
          function b(t) {
            return y[t] || (y[t] = new String(t));
          }
          var w = new WeakMap();
          function x(t, e, n) {
            n = b(n);
            var i = w.get(t);
            i || w.set(t, (i = new WeakMap()));
            var o = i.get(n);
            o || i.set(n, (o = new Map()));
            var r = o.get(e);
            if (r) return r;
          ...
          var S = f(window.Event)
            ...
            E = f(window.CustomEvent)
              ? window.CustomEvent
              : ((E.prototype = Object.create(S.prototype)), E),
            C = {
              trigger: function (t, e) {
                var n = { bubbles: !0 };
                return (
                  p(e)
                    ? this.node.dispatchEvent(new E(t, i({ detail: e }, n)))
                    : this.node.dispatchEvent(new S(t, n)),
                  this
                );
              },
              on: function (t, e) {
                return this.node.addEventListener(t, x(this.node, e, t)), this;
              },
              off: function (t, e) {
                return (
                  this.node.removeEventListener(t, x.get(this.node, e, t)), this
                );
              },
            },
            O = /^rateyo(.+)$/;
          ...
          (T.add = "add"),
            ...
            (L.prototype = {
              ...
              addClass: function (t) {
                return T(this.node, T.add, t), this;
              },
              removeClass: function (t) {
                return T(this.node, T.remove, t), this;
              },
              appendTo: function (t) {
                return (L.isEl(t) ? t.node : t).appendChild(this.node), this;
              },
              css: function (t, e) {
                return (this.node.style[t] = e), this;
              },
              width: function (t) {
                if (!p(t)) return this.node.getBoundingClientRect().width;
                this.css("width", t + (u(t, "number") ? "px" : ""));
              },
              find: function (t) {
                return M(this.node.querySelectorAll(t));
              },
              attr: function (t) {
                for (var e in t)
                  t.hasOwnProperty(e) && this.node.setAttribute(e, t[e]);
            ...
            (L.prototype = i(i({}, L.prototype), C)),
            (L.isEl = function (t) {
              return t instanceof L;
            }),
            (I.isCollection = function (t) {
              return t instanceof I;
            }),
            (I.prototype = {});
          var k = function (t) {
            if (!L.prototype.hasOwnProperty(t)) return "continue";
            I.prototype[t] = function () {
              ...
              return (
                this.collection.forEach(function (e) {
                  return L.isEl(e) && e[t].apply(e, n);
                }),
                this
              );
            };
          };
          for (var _ in L.prototype) k(_);
          var A = new DOMParser();
          function M(t) {
            var e;
            return (
              (t =
                (u(t, "string") &&
                  ((e = t),
                  A.parseFromString(e.trim(), "text/html").body.childNodes)) ||
                t),
              L.isEl(t) || I.isCollection(t)
                ? t
                : t instanceof NodeList
                ? new I(t)
                : new L(t)
          ...
          function P(t) {
            ...
            this.node = t;
            var u = M(t);
            (e = i(i(i({}, r), e), u.dataAttrOptions())),
              u.empty().addClass("jq-ry-container");
            var f,
              h,
              g,
              m,
              y,
              b,
              w = M(document.createElement("div"))
                .addClass("jq-ry-group-wrapper")
                .appendTo(u),
              x = M(document.createElement("div"))
                .addClass("jq-ry-normal-group")
                .addClass("jq-ry-group")
                .appendTo(w),
              S = M(document.createElement("div"))
                .addClass("jq-ry-rated-group")
                .addClass("jq-ry-group")
                .appendTo(w),
              E = 0,
            ...
            function T(t) {
              ...
              var n = t / f,
                i = n * g;
              n > 1 && (i += (Math.ceil(n) - 1) * y),
                D(e.ratedFill),
                (i = e.rtl ? 100 - i : i) < 0 ? (i = 0) : i > 100 && (i = 100),
                S.css("width", i + "%");
            }
            function L() {
              (b = h * e.numStars + m * (e.numStars - 1)),
                (g = (h / b) * 100),
                (y = (m / b) * 100),
                u.width(b),
                T();
            ...
            function I(t) {
              var n = (e.starWidth = t);
              return (
                (h = window.parseFloat(e.starWidth.replace("px", ""))),
                x.find("svg").attr({ width: e.starWidth, height: n }),
                S.find("svg").attr({ width: e.starWidth, height: n }),
                L(),
                u
            ...
            function D(t) {
              if (e.multiColor) {
                var n = ((C - E) / e.maxValue) * 100,
                  i = e.multiColor || {};
                t = v(i.startColor || s, i.endColor || a, n);
              } else A = t;
              return (
                (e.ratedFill = t),
                (e.rtl ? x : S).find("svg").attr({ fill: e.ratedFill }),
            ...
            function B(t) {
              (e.multiColor = t), D(t || A);
            }
            function F(t) {
              (e.numStars = t),
                (f = e.maxValue / e.numStars),
                x.empty(),
                S.empty();
              for (var n = 0; n < e.numStars; n++)
                M(e.starSvg || o).appendTo(x), M(e.starSvg || o).appendTo(S);
              return I(e.starWidth), _(e.normalFill), k(e.spacing), T(), u;
            }
            function q(t) {
              return (
                (e.maxValue = t),
            ...
            function W(t) {
              return (e.precision = t), Y(e.rating), u;
            }
            function N(t) {
              return (e.halfStar = t), u;
            }
            function H(t) {
              return (e.fullStar = t), u;
            }
            function V(t) {
              var n = t % f,
                i = f / 2,
            ...
            function R(t) {
              ...
              return e.rtl && (s = o - s), parseFloat(s);
            }
            function $(t) {
              return (
                (e.readOnly = t),
            ...
            function Y(t) {
              ...
              return (
                "string" == typeof n &&
                  ("%" === n[n.length - 1] &&
                    ((n = n.substr(0, n.length - 1)), q((i = 100))),
                  (n = parseFloat(n))),
                d(n, E, i),
                (n = parseFloat(n.toFixed(e.precision))),
                c(parseFloat(n), E, i),
                (e.rating = n),
                T(),
                O && u.trigger("rateyo.set", { rating: n }),
                u
              );
            }
            function G(t) {
            ...
            function X(t) {
              return (e.onChange = t), u;
            }
            function K(t) {
              if (e.hover) {
                var n = R(t).toFixed(e.precision),
                  i = e.maxValue;
                T((n = c(parseFloat(n), E, i))),
                  u.trigger("rateyo.change", { rating: n });
              }
            }
            function J() {
              !l() &&
                e.hover &&
                (T(), u.trigger("rateyo.change", { rating: e.rating }));
            }
            function Z(t) {
              var i = R(t).toFixed(e.precision);
              (i = parseFloat(i)), n.rating(i);
            ...
            (this.rating = function (t) {
              return p(t) ? (Y(t), u) : e.rating;
            }),
              (this.destroy = function () {
                return (
                  e.readOnly || it(),
                  z.delete(t),
                  u.removeClass("jq-ry-container").children().remove(),
                  u
                );
              }),
              (this.method = function (t) {
                if (!t) throw Error("Method name not specified!");
                if (!p(this[t])) throw Error("Method " + t + " doesn't exist!");
                var e = Array.prototype.slice.apply(arguments, []),
                  n = e.slice(1),
                  i = this[t];
                return i.apply(this, n);
              ...
              this.rating(e.rating, !0),
              (O = !0),
              u.trigger("rateyo.init", { rating: e.rating });
          }
          Object.defineProperty(P.prototype, "on", {
            value: function (t, e) {
              return M(this.node).on(t, e), this;
            },
          }),
            Object.defineProperty(P.prototype, "off", {
              value: function (t, e) {
                return M(this.node).off(t, e), this;
              },
            }),
