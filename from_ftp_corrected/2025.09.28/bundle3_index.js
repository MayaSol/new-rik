...
!(function () {
  var t = {
      ...
      802: function (t, e, n) {
        ...
        o(function () {
          ...
          t.navMobileOpen && c(t),
            document
              ...
              .addEventListener('click', function (t) {
                let e = r(this, '.search-form');
                if (e.length > 0) {
                  if (e[0].navMobileOpen) return;
                  e[0].classList.contains('active')
                    ? (l(e[0]), e[0].classList.remove('active'))
                    : (c(e[0]),
        ...
        var s = !1,
          c = function (t) {
            ...
            if ((t.navMobileOpen, e < 1024)) {
              var n = i(t)[0],
                o = document.getElementsByClassName('main-nav__toggler')[0],
                r = i(o)[0];
              console.log(e), console.log(r);
              var a = t.querySelector('.search-form__input-wrapper');
              (t.style.transform = 'translateX('.concat(r - n, 'px)')),
                (a.style.width = r + 'px'),
                (a.style.maxWidth = r + 'px'),
        ...
        (e.mobileSearchOpen = c), (e.mobileSearchClose = l);
      },
      6264: function (t, e, n) {
        const o = n(4783);
        n(6178),
