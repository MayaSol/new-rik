...
!(function () {
  var t = {
      ...
      9196: function(t, e, n) {
        ...
        n(6178),
        o(function() {
          //!!! В <video> должен быть атрибут muted, чтобы разрешить автозапуск и play из js
          ...
          if (videos.length > 0) {
            for (let i=0; i<videos.length; i++) {
              ...
              const playBtn = r(video, '.slider-main__media')[0].querySelector('.slider-main__btn-play');
              if (playBtn) {
            ...
            if (document.querySelector('.slider-main')) {
              if (!sliderMain || !sliderMain.version) {
                ...
                sliderMain.events.on('transitionEnd', function(info) {
                  ...
                  console.log('=== Проверка autoplay ===');
                  console.log('getAttribute:', videoElement.getAttribute('autoplay'));
                  console.log('hasAttribute:', videoElement.hasAttribute('autoplay'));
                  console.log('autoplay property:', videoElement.autoplay);
                  console.log('attributes:', videoElement.attributes.autoplay);
                  console.log('======================');                      
                  if (video) {
                    playVideo(video);
                  }
