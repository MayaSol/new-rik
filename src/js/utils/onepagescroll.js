...
ready(function() {
  ...
  if (document.documentElement.classList.contains('index') && document.documentElement.clientWidth >= 1024) {
...
Object.extend = function(orig) {
  ...
  return orig;
    ...
    onePageScroll(".main", {
      ...
      afterMove: function(index) {onFirstMove();}, // This option accepts a callback function. The function will be called after the page moves.
