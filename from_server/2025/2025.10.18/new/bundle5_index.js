            ...
            if (document.querySelector('.slider-main')) {
              if (!sliderMain || !sliderMain.version) {
                ...
                sliderMain.events.on('transitionEnd', function(info) {
                  ...
                  console.log('getAttribute:', video.getAttribute('autoplay'));
                  console.log('hasAttribute:', video.hasAttribute('autoplay'));
                  console.log('autoplay property:', video.autoplay);
                  console.log('attributes:', video.attributes.autoplay);
                  console.log('======================');                   
                  if (video) {
                    playVideo(video);
                  }
