          ...
          function onPlay(videoEl) {
            ...
            console.log('onPLay if (sliderMain && videoEl._duration)',videoEl,videoEl._duration);
              ...
              videoEl._slideTimeout = setTimeout(() => {
                console.log('videoEl ended slider play',videoEl,videoEl._duration);
